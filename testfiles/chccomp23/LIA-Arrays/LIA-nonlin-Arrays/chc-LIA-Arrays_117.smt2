; ./prepared/synth/semgus/./bound.no21_cubearray_07_100_000.smt2
(set-logic HORN)


(declare-fun |funcS2__sem| ( (Array Int Int) Int Bool Bool (Array Int Int) Int Int Int (Array Int Int) Int Int Int Int (Array Int Int) Int (Array Int Int) Int Int Int (Array Int Int) Int Int Int ) Bool)
...
(declare-fun |funcS2__syn| ( (Array Int Int) Int Bool Bool (Array Int Int) Int Int Int (Array Int Int) Int Int Int Int (Array Int Int) Int (Array Int Int) Int Int Int (Array Int Int) Int Int Int ) Bool)
...
(declare-fun |funcP__syn| ( (Array Int Int) Int Bool Bool (Array Int Int) Int Int Int (Array Int Int) Int Int Int Int (Array Int Int) Int Int Int ) Bool)
...
(declare-fun |funcS1__sem| ( (Array Int Int) Int Bool Bool (Array Int Int) Int Int Int (Array Int Int) Int Int Int Int (Array Int Int) Int (Array Int Int) Int Int Int (Array Int Int) Int Int Int ) Bool)
...
(declare-fun |funcS1__syn| ( (Array Int Int) Int Bool Bool (Array Int Int) Int Int Int (Array Int Int) Int Int Int Int (Array Int Int) Int (Array Int Int) Int Int Int (Array Int Int) Int Int Int ) Bool)
(declare-fun |funcP__sem| ( (Array Int Int) Int Bool Bool (Array Int Int) Int Int Int (Array Int Int) Int Int Int Int (Array Int Int) Int Int Int ) Bool)
  ...
  (forall ( (A Int) (B (Array Int Int)) (C Int) (D Int) (E (Array Int Int)) (F Int) (G (Array Int Int)) (H Int) (I Bool) (J Bool) (K (Array Int Int)) (L Int) (M Int) (N Int) (O (Array Int Int)) (P Int) (Q Int) (R Int) (S Int) (T (Array Int Int)) (U Int) (V Int) (W Int) (X Int) (Y Int) ) 
    (=>
      (and
        ...
        (and (= A (+ 1 H)) (= D (+ V W)) (= B (store G H 9)) (= C (+ X Y)))
      )
...
(assert
  (forall ( (A Int) (B (Array Int Int)) (C (Array Int Int)) (D (Array Int Int)) (E (Array Int Int)) (F Int) (G (Array Int Int)) (H Int) (I Int) (J (Array Int Int)) (K Int) (L Bool) (M Int) (N Int) (O (Array Int Int)) (P Int) (Q Int) (R Int) (S Bool) (T Int) (U Int) (V (Array Int Int)) (W Int) (X Int) (Y Int) (v_25 Int) (v_26 Int) (v_27 Int) (v_28 Int) (v_29 Int) (v_30 Int) ) 
    (=>
      (and
        (funcE__syn E F L S O P Q R V W X Y I J K N U)
        (funcA__syn B A L S O P Q R V W X Y I E F M T)
        (and (= D (ite L (store O M N) O))
     ...
     (= v_30 Y))
      ...
      (funcS1__syn G H L S O P Q R V W X Y I J K D v_25 v_26 v_27 C v_28 v_29 v_30)
    )
  )
)
(assert
  (forall ( (A Int) (B (Array Int Int)) (C (Array Int Int)) (D Int) (E (Array Int Int)) (F Int) (G Int) (H Int) (I (Array Int Int)) (J Int) (K Int) (L Int) (M (Array Int Int)) (N Int) (O Bool) (P Bool) (Q (Array Int Int)) (R Int) (S Int) (T Int) (U (Array Int Int)) (V Int) (W Int) (X Int) (Y Int) (Z (Array Int Int)) (A1 Int) (B1 (Array Int Int)) (C1 Int) (D1 Int) (E1 Int) (F1 (Array Int Int)) (G1 Int) (H1 Int) (I1 Int) ) 
    (=>
      (and
        (funcS1__syn C D O P E F G H I J K L Y Z A1 B1 C1 D1 E1 F1 G1 H1 I1)
        (funcS1__syn B A O P Q R S T U V W X Y C D E F G H I J K L)
        (and (= B (store M N 21)) (= A (+ 1 N)))
      )
      (funcS1__syn M N O P Q R S T U V W X Y Z A1 B1 C1 D1 E1 F1 G1 H1 I1)
    )
  )
)
(assert
  (forall ( (A Int) (B (Array Int Int)) (C Int) (D Int) (E (Array Int Int)) (F Int) (G Int) (H (Array Int Int)) (I Int) (J (Array Int Int)) (K Int) (L Int) (M Bool) (N Int) (O Int) (P (Array Int Int)) (Q Int) (R Int) (S Bool) (T Int) (U Int) (v_21 (Array Int Int)) (v_22 Int) (v_23 Int) (v_24 (Array Int Int)) (v_25 Int) (v_26 Int) ) 
    (=>
     ...
     (= v_26 R))
      ...
      (funcS1__syn E F M S J K L O P Q R U G H I v_21 v_22 v_23 D v_24 v_25 v_26 C)
    )
  )
)
(assert
  (forall ( (A Int) (B (Array Int Int)) (C Int) (D Int) (E (Array Int Int)) (F Int) (G Int) (H (Array Int Int)) (I Int) (J (Array Int Int)) (K Int) (L Bool) (M Int) (N Int) (O Int) (P (Array Int Int)) (Q Int) (R Bool) (S Int) (T Int) (U Int) (v_21 (Array Int Int)) (v_22 Int) (v_23 Int) (v_24 (Array Int Int)) (v_25 Int) (v_26 Int) ) 
    (=>
     ...
     (= v_26 U))
      ...
      (funcS1__syn E F L R J K N O P Q T U G H I v_21 v_22 D v_23 v_24 v_25 C v_26)
    )
  )
)
(assert
  ...
  (forall ( (A Bool) (B Bool) (C (Array Int Int)) (D Int) (E (Array Int Int)) (F Int) (G Bool) (H Bool) (I (Array Int Int)) (J Int) (K (Array Int Int)) (L Int) (M Int) (N (Array Int Int)) (O Int) (P Int) (Q Int) (R Int) (S Int) ) 
    (=>
     ...
     (= D O))
      ...
      (funcB__syn E F G H I P Q J K R S L M N O B A)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C (Array Int Int)) (D Int) (E (Array Int Int)) (F Int) (G Bool) (H Bool) (I (Array Int Int)) (J Int) (K Int) (L (Array Int Int)) (M Int) (N Int) (O Int) (P (Array Int Int)) (Q Int) (R Int) (S Int) ) 
    (=>
      (and
        (and (= B (+ 1 R))
     (= F (+ (- 1) D))
     ...
     (= D Q))
      ...
      (funcP__syn E F G H I R J K L S M N O P Q B A)
    )
  )
)
(assert
  (forall ( (A Int) (B (Array Int Int)) (C Int) (D Int) (E (Array Int Int)) (F Int) (G Int) (H (Array Int Int)) (I Int) (J (Array Int Int)) (K Bool) (L Int) (M Int) (N Int) (O Int) (P (Array Int Int)) (Q Bool) (R Int) (S Int) (T Int) (U Int) (v_21 (Array Int Int)) (v_22 Int) (v_23 Int) (v_24 (Array Int Int)) (v_25 Int) (v_26 Int) ) 
    (=>
      (and
        (funcP__syn B A K Q J M N O P S T U G H I L R)
        (and (= D (ite K L M))
     (= C (ite Q R S))
     (= B (store E F 14))
     (= A (+ 1 F))
     ...
     (= v_26 U))
      ...
      (funcS2__syn E F K Q J M N O P S T U G H I v_21 D v_22 v_23 v_24 C v_25 v_26)
    )
  )
)
(assert
  (forall ( (A Int) (B (Array Int Int)) (C (Array Int Int)) (D Int) (E (Array Int Int)) (F Int) (G Int) (H Int) (I (Array Int Int)) (J Int) (K Int) (L Int) (M (Array Int Int)) (N Int) (O Bool) (P Bool) (Q (Array Int Int)) (R Int) (S Int) (T Int) (U (Array Int Int)) (V Int) (W Int) (X Int) (Y Int) (Z (Array Int Int)) (A1 Int) (B1 (Array Int Int)) (C1 Int) (D1 Int) (E1 Int) (F1 (Array Int Int)) (G1 Int) (H1 Int) (I1 Int) ) 
    (=>
      (and
        (funcS2__syn C D O P E F G H I J K L Y Z A1 B1 C1 D1 E1 F1 G1 H1 I1)
        (funcS1__syn B A O P Q R S T U V W X Y C D E F G H I J K L)
  ...
  (forall ( (A Int) (B Int) (C Int) (D (Array Int Int)) (E Int) (F (Array Int Int)) (G Int) (H Bool) (I Bool) (J (Array Int Int)) (K Int) (L Int) (M Int) (N (Array Int Int)) (O Int) (P Int) (Q Int) (R Int) (S (Array Int Int)) (T Int) (U Int) (V Int) (W Int) (X Int) ) 
    (=>
      (and
        ...
        (and (= B (+ W X)) (= A (+ 1 G)) (= C (+ U V)) (= 9 (select F G)))
      )
...
(assert
  (forall ( (A Int) (B (Array Int Int)) (C (Array Int Int)) (D (Array Int Int)) (E Int) (F (Array Int Int)) (G Int) (H Int) (I (Array Int Int)) (J Int) (K Bool) (L Int) (M Int) (N (Array Int Int)) (O Int) (P Int) (Q Int) (R Bool) (S Int) (T Int) (U (Array Int Int)) (V Int) (W Int) (X Int) (v_24 Int) (v_25 Int) (v_26 Int) (v_27 Int) (v_28 Int) (v_29 Int) ) 
    (=>
      (and
        (funcA__sem F A K R N O P Q U V W X H D E L S)
        (funcE__sem D E K R N O P Q U V W X H I J M T)
        (and (= A (+ 1 G))
     ...
     (= v_29 X))
      ...
      (funcS1__sem F G K R N O P Q U V W X H I J C v_24 v_25 v_26 B v_27 v_28 v_29)
    )
  )
)
(assert
  (forall ( (A Int) (B (Array Int Int)) (C Int) (D (Array Int Int)) (E Int) (F Int) (G Int) (H (Array Int Int)) (I Int) (J Int) (K Int) (L (Array Int Int)) (M Int) (N Bool) (O Bool) (P (Array Int Int)) (Q Int) (R Int) (S Int) (T (Array Int Int)) (U Int) (V Int) (W Int) (X Int) (Y (Array Int Int)) (Z Int) (A1 (Array Int Int)) (B1 Int) (C1 Int) (D1 Int) (E1 (Array Int Int)) (F1 Int) (G1 Int) (H1 Int) ) 
    (=>
      (and
        (funcS1__sem L A N O P Q R S T U V W X B C D E F G H I J K)
        (funcS1__sem B C N O D E F G H I J K X Y Z A1 B1 C1 D1 E1 F1 G1 H1)
        (and (= A (+ 1 M)) (= 21 (select L M)))
      )
      (funcS1__sem L M N O P Q R S T U V W X Y Z A1 B1 C1 D1 E1 F1 G1 H1)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C Int) (D (Array Int Int)) (E Int) (F Int) (G (Array Int Int)) (H Int) (I (Array Int Int)) (J Int) (K Int) (L Bool) (M Int) (N Int) (O (Array Int Int)) (P Int) (Q Int) (R Bool) (S Int) (T Int) (v_20 (Array Int Int)) (v_21 Int) (v_22 Int) (v_23 (Array Int Int)) (v_24 Int) (v_25 Int) ) 
    (=>
     ...
     (= v_25 Q))
      ...
      (funcS1__sem D E L R I J K N O P Q T F G H v_20 v_21 v_22 C v_23 v_24 v_25 B)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C Int) (D (Array Int Int)) (E Int) (F Int) (G (Array Int Int)) (H Int) (I (Array Int Int)) (J Int) (K Bool) (L Int) (M Int) (N Int) (O (Array Int Int)) (P Int) (Q Bool) (R Int) (S Int) (T Int) (v_20 (Array Int Int)) (v_21 Int) (v_22 Int) (v_23 (Array Int Int)) (v_24 Int) (v_25 Int) ) 
    (=>
     ...
     (= v_25 T))
      ...
      (funcS1__sem D E K Q I J M N O P S T F G H v_20 v_21 C v_22 v_23 v_24 B v_25)
    )
  )
)
(assert
  ...
  (forall ( (A Bool) (B Bool) (C (Array Int Int)) (D Int) (E (Array Int Int)) (F Int) (G Bool) (H Bool) (I (Array Int Int)) (J Int) (K (Array Int Int)) (L Int) (M Int) (N (Array Int Int)) (O Int) (P Int) (Q Int) (R Int) (S Int) ) 
    (=>
     ...
     (= 1 (select E F)))
      ...
      (funcB__sem E F G H I P Q J K R S L M N O B A)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C (Array Int Int)) (D Int) (E (Array Int Int)) (F Int) (G Bool) (H Bool) (I (Array Int Int)) (J Int) (K Int) (L (Array Int Int)) (M Int) (N Int) (O Int) (P (Array Int Int)) (Q Int) (R Int) (S Int) ) 
    (=>
     ...
     (= 22 (select E F)))
      ...
      (funcP__sem E F G H I R J K L S M N O P Q B A)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C Int) (D (Array Int Int)) (E Int) (F Int) (G (Array Int Int)) (H Int) (I (Array Int Int)) (J Bool) (K Int) (L Int) (M Int) (N Int) (O (Array Int Int)) (P Bool) (Q Int) (R Int) (S Int) (T Int) (v_20 (Array Int Int)) (v_21 Int) (v_22 Int) (v_23 (Array Int Int)) (v_24 Int) (v_25 Int) ) 
    (=>
      (and
        (funcP__sem D A J P I L M N O R S T F G H K Q)
        (and (= A (+ 1 E))
     (= C (ite J K L))
     (= B (ite P Q R))
     (= 14 (select D E))
     ...
     (= v_25 T))
      ...
      (funcS2__sem D E J P I L M N O R S T F G H v_20 C v_21 v_22 v_23 B v_24 v_25)
    )
  )
)
(assert
  (forall ( (A Int) (B (Array Int Int)) (C Int) (D (Array Int Int)) (E Int) (F Int) (G Int) (H (Array Int Int)) (I Int) (J Int) (K Int) (L (Array Int Int)) (M Int) (N Bool) (O Bool) (P (Array Int Int)) (Q Int) (R Int) (S Int) (T (Array Int Int)) (U Int) (V Int) (W Int) (X Int) (Y (Array Int Int)) (Z Int) (A1 (Array Int Int)) (B1 Int) (C1 Int) (D1 Int) (E1 (Array Int Int)) (F1 Int) (G1 Int) (H1 Int) ) 
    (=>
      (and
        (funcS1__sem L A N O P Q R S T U V W X B C D E F G H I J K)
        (funcS2__sem B C N O D E F G H I J K X Y Z A1 B1 C1 D1 E1 F1 G1 H1)
...
(assert
  (forall ( (A (Array Int Int)) (B (Array Int Int)) (C (Array Int Int)) (D (Array Int Int)) (E (Array Int Int)) (F (Array Int Int)) (G Int) (H (Array Int Int)) (I Int) (J Int) (K Int) (L (Array Int Int)) (M Int) (N Int) (O Int) (v_15 Int) (v_16 Bool) (v_17 Bool) (v_18 Int) (v_19 Int) (v_20 Int) (v_21 Int) (v_22 Int) (v_23 Int) (v_24 Int) ) 
    (=>
      (and
        (funcStart__syn E
                v_15
                ...
                N
                O)
        (let ((a!1 (= B (store (store (store H 0 1) 1 8) 2 27)))
      (a!2 (= D (store (store (store H 0 1) 1 2) 2 3)))
      (a!3 (= A (store (store (store L 0 8) 1 27) 2 64)))
      (a!4 (= C (store (store (store L 0 2) 1 3) 2 4))))
  (and (= 0 v_15)
       (= v_16 true)
       (= v_17 true)
       (= 0 v_18)

; ./prepared/synth/semgus/./nthbit.no24_min_07_1_000.smt2
(set-logic HORN)
...
(assert
  (forall ( (A Bool) (B Bool) (C Bool) (D Bool) (E (Array Int Int)) (F Int) (G (Array Int Int)) (H Int) (I Bool) (J Bool) (K (Array Int Int)) (L Bool) (M Bool) (N Bool) (O Bool) (P Bool) (Q (Array Int Int)) (R Bool) (S Bool) (T Bool) (U Bool) (V Bool) (W (Array Int Int)) (X Int) (Y Bool) (Z Bool) (A1 Bool) (B1 Bool) ) 
    (=>
      (and
        (and (= H (+ (- 1) F))
     (= (store G H 22) E)
     ...
     (= F X))
      ...
      (funcP__syn G H I J K L Y Z M N O P Q R A1 B1 S T U V W X D C B A)
    )
  )
)
(assert
  ...
  (forall ( (A Bool) (B Bool) (C Bool) (D Bool) (E (Array Int Int)) (F Int) (G (Array Int Int)) (H Int) (I Bool) (J Bool) (K (Array Int Int)) (L Bool) (M Bool) (N Bool) (O Bool) (P Bool) (Q (Array Int Int)) (R Bool) (S Bool) (T Bool) (U Bool) (V Bool) (W (Array Int Int)) (X Int) (Y Bool) (Z Bool) (A1 Bool) (B1 Bool) ) 
    (=>
     ...
     (= 22 (select G H)))
      ...
      (funcP__sem G H I J K L Y Z M N O P Q R A1 B1 S T U V W X D C B A)
    )
  )
)
(assert

; ./prepared/synth/semgus/./nthbit.no22_quartarray_01_3_000.smt2
(set-logic HORN)
    ...
    (=>
      (and
        (funcStart__syn K
                ...
                A
                K1)
        (let ((a!1 (= I (store (store (store A1 0 2) 1 3) 2 4)))
      (a!2 (ite B1 Z (store (store (store A1 0 16) 1 81) 2 256)))
      (a!3 (= J (store (store (store O 0 1) 1 2) 2 3)))
      (a!4 (ite P N (store (store (store O 0 1) 1 16) 2 81))))
  (and (= 0 v_37)
       (= v_38 true)
       (= v_39 true)
       (= v_40 false)

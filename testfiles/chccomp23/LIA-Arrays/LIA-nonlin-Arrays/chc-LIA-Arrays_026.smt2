; ./prepared/synth/semgus/./nosynArray.no23_max_10_000.smt2
(set-logic HORN)
...
(assert
  (forall ( (A Int) (B Bool) (C Bool) (D Bool) (E Bool) (F Int) (G Int) (H (Array Int Int)) (I Int) (J (Array Int Int)) (K Int) (L (Array Int Int)) (M Int) (N Bool) (O Bool) (P (Array Int Int)) (Q Int) (R Int) (S Int) (T (Array Int Int)) (U Int) (V Int) (W Int) (X (Array Int Int)) (Y Int) (Z Bool) (A1 Int) (B1 Int) (C1 Bool) (D1 Int) (E1 Int) ) 
    (=>
      (and
        (funcE__sem H I E D P Q R S T U V W J K A1 D1)
        (funcE__sem J K C B P Q R S T U V W X Y B1 E1)
        (funcB__sem L A N O P Q R S T U V W H I Z C1)
        (and (= A (+ 1 M))
     (= G (ite Z A1 B1))
     (= F (ite C1 D1 E1))
     (= E (and Z N))
     ...
     (= 13 (select L M)))
      ...
      (funcE__sem L M N O P Q R S T U V W X Y G F)
    )
  )
)
(assert
    ...
    (=>
      (and
        (funcStart__sem C
                ...
                M
                v_23)
        (let ((a!1 (= B (store (store (store D 0 (- 1)) 1 (- 2)) 2 (- 3))))
      (a!2 (store (store (store (store E 0 3) 1 2) 2 17) 3 5)))
  (and (= 0 v_13)
       (= v_14 true)
       (= v_15 true)
       (= 0 v_16)

; ./prepared/synth/semgus/./bound.no23_max_01_100_000.smt2
(set-logic HORN)
...
(assert
  (forall ( (A Bool) (B Bool) (C Int) (D (Array Int Int)) (E Bool) (F Bool) (G Int) (H Int) (I (Array Int Int)) (J Int) (K (Array Int Int)) (L Int) (M (Array Int Int)) (N Int) (O Bool) (P Bool) (Q (Array Int Int)) (R Int) (S Int) (T Int) (U (Array Int Int)) (V Int) (W Int) (X Int) (Y Int) (Z (Array Int Int)) (A1 Int) (B1 Bool) (C1 Int) (D1 Int) (E1 Bool) (F1 Int) (G1 Int) ) 
    (=>
      (and
        (funcE__syn K L F E Q R S T U V W X Y Z A1 D1 G1)
        (funcB__syn D C O P Q R S T U V W X Y I J B1 E1)
        (funcE__syn I J B A Q R S T U V W X Y K L C1 F1)
        (and (= G (ite E1 F1 G1))
     (= C (+ 1 N))
     (= D (store M N 13))
     (= F (and (not B1) O))
     ...
     (= H (ite B1 C1 D1)))
      ...
      (funcE__syn M N O P Q R S T U V W X Y Z A1 H G)
    )
  )
)
(assert
...
(assert
  (forall ( (A Int) (B (Array Int Int)) (C Bool) (D Bool) (E (Array Int Int)) (F Int) (G (Array Int Int)) (H Int) (I Bool) (J Bool) (K (Array Int Int)) (L Int) (M Int) (N Int) (O (Array Int Int)) (P Int) (Q Int) (R Int) (S Int) (T (Array Int Int)) (U Int) (V Int) (W Int) (X Int) (Y Int) ) 
    (=>
      (and
        (funcA__syn E F I J K L M N O P Q R S T U W Y)
        (funcA__syn B A I J K L M N O P Q R S E F V X)
     ...
     (= A (+ 1 H)))
      ...
      (funcB__syn G H I J K L M N O P Q R S T U D C)
    )
  )
)
(assert
  (forall ( (A Int) (B (Array Int Int)) (C (Array Int Int)) (D (Array Int Int)) (E (Array Int Int)) (F Int) (G (Array Int Int)) (H Int) (I Int) (J (Array Int Int)) (K Int) (L Bool) (M Int) (N Int) (O (Array Int Int)) (P Int) (Q Int) (R Int) (S Bool) (T Int) (U Int) (V (Array Int Int)) (W Int) (X Int) (Y Int) (v_25 Int) (v_26 Int) (v_27 Int) (v_28 Int) (v_29 Int) (v_30 Int) ) 
    (=>
     ...
     (= v_30 Y))
      ...
      (funcS__syn G H L S O P Q R V W X Y I J K D v_25 v_26 v_27 C v_28 v_29 v_30)
    )
  )
)
(assert
...
(assert
  (forall ( (A Int) (B Bool) (C Bool) (D Bool) (E Bool) (F Int) (G Int) (H (Array Int Int)) (I Int) (J (Array Int Int)) (K Int) (L (Array Int Int)) (M Int) (N Bool) (O Bool) (P (Array Int Int)) (Q Int) (R Int) (S Int) (T (Array Int Int)) (U Int) (V Int) (W Int) (X Int) (Y (Array Int Int)) (Z Int) (A1 Bool) (B1 Int) (C1 Int) (D1 Bool) (E1 Int) (F1 Int) ) 
    (=>
      (and
        (funcE__sem H I E D P Q R S T U V W X J K B1 E1)
        (funcE__sem J K C B P Q R S T U V W X Y Z C1 F1)
        (funcB__sem L A N O P Q R S T U V W X H I A1 D1)
        (and (= A (+ 1 M))
     (= G (ite A1 B1 C1))
     (= F (ite D1 E1 F1))
     (= B (and (not D1) O))
     ...
     (= 13 (select L M)))
      ...
      (funcE__sem L M N O P Q R S T U V W X Y Z G F)
    )
  )
)
(assert
...
(assert
  (forall ( (A Int) (B Bool) (C Bool) (D (Array Int Int)) (E Int) (F (Array Int Int)) (G Int) (H Bool) (I Bool) (J (Array Int Int)) (K Int) (L Int) (M Int) (N (Array Int Int)) (O Int) (P Int) (Q Int) (R Int) (S (Array Int Int)) (T Int) (U Int) (V Int) (W Int) (X Int) ) 
    (=>
      (and
        (funcA__sem F A H I J K L M N O P Q R D E U W)
        (funcA__sem D E H I J K L M N O P Q R S T V X)
        (and (= A (+ 1 G)) (not (= (<= V U) C)) (not (= (<= X W) B)) (= 1 (select F G)))
      )
      (funcB__sem F G H I J K L M N O P Q R S T C B)
    )
  )
)
(assert
  (forall ( (A Int) (B (Array Int Int)) (C (Array Int Int)) (D (Array Int Int)) (E Int) (F (Array Int Int)) (G Int) (H Int) (I (Array Int Int)) (J Int) (K Bool) (L Int) (M Int) (N (Array Int Int)) (O Int) (P Int) (Q Int) (R Bool) (S Int) (T Int) (U (Array Int Int)) (V Int) (W Int) (X Int) (v_24 Int) (v_25 Int) (v_26 Int) (v_27 Int) (v_28 Int) (v_29 Int) ) 
    (=>
     ...
     (= v_29 X))
      ...
      (funcS__sem F G K R N O P Q U V W X H I J C v_24 v_25 v_26 B v_27 v_28 v_29)
    )
  )
)
(assert
    ...
    (=>
      (and
        (funcStart__syn C
                ...
                M
                v_24)
        (let ((a!1 (store (store (store (store E 0 3) 1 2) 2 17) 3 5))
      (a!2 (= B (store (store (store D 0 (- 1)) 1 (- 2)) 2 (- 3)))))
  (and (= 0 v_13)
       (= v_14 true)
       (= v_15 true)
       (= 0 v_16)

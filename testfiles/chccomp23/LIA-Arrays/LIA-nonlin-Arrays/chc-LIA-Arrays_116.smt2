; ./prepared/synth/semgus/./nthbit.no01_factorialTest_01_2_000.smt2
(set-logic HORN)
...
(declare-fun |funcE__sem| ( (Array Int Int) Int Bool Bool Bool Bool Bool Bool Bool Bool Bool Bool Bool Bool Bool Bool Bool Bool Bool Bool Bool Bool (Array Int Int) Int Bool Bool Bool Bool Bool Bool Bool Bool ) Bool)

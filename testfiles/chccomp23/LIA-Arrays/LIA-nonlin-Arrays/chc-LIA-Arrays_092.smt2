; ./prepared/synth/semgus/./bound.no03_sigmaTest_03_10_000.smt2
(set-logic HORN)
...
(assert
  (forall ( (A (Array Int Int)) (B Int) (C Bool) (D Bool) (E Bool) (F Bool) (G Int) (H Int) (I Int) (J Int) (K Int) (L Int) (M Int) (N Int) (O Int) (P (Array Int Int)) (Q Int) (v_17 Int) (v_18 Int) (v_19 Int) (v_20 Int) ) 
    (=>
      (and
        (and (= (store A B 6) P)
     (= B (+ (- 1) Q))
     ...
     (= 1 v_20))
      ...
      (funcA__syn A B C D E F G H I J K L M N O P Q v_17 v_18 v_19 v_20)
    )
  )
)
(assert
...
(assert
  (forall ( (A Int) (B (Array Int Int)) (C Bool) (D Bool) (E Bool) (F Bool) (G (Array Int Int)) (H Int) (I (Array Int Int)) (J Int) (K Bool) (L Bool) (M Bool) (N Bool) (O Int) (P Int) (Q Int) (R Int) (S Int) (T Int) (U Int) (V Int) (W Int) (X (Array Int Int)) (Y Int) (Z Int) (A1 Int) (B1 Int) (C1 Int) (D1 Int) (E1 Int) (F1 Int) (G1 Int) ) 
    (=>
      (and
        (funcA__syn G H K L M N O P Q R S T U V W X Y A1 C1 E1 G1)
        (funcA__syn B A K L M N O P Q R S T U V W G H Z B1 D1 F1)
     ...
     (= A (+ 1 J)))
      ...
      (funcB__syn I J K L M N O P Q R S T U V W X Y F E D C)
    )
  )
)
(assert
  (forall ( (A Int) (B (Array Int Int)) (C (Array Int Int)) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Int) (L Int) (M (Array Int Int)) (N Int) (O Bool) (P Bool) (Q Bool) (R Bool) (S Int) (T Int) (U Int) (V Int) (W Int) (X Int) (Y Int) (Z Int) (A1 Int) (B1 (Array Int Int)) (C1 Int) (D1 Int) (E1 Int) (F1 Int) (G1 Int) (H1 Int) (I1 Int) (J1 Int) (K1 Int) ) 
    (=>
      (and
        (funcS__syn C D O P Q R E F G H I J K L A1 B1 C1 D1 E1 F1 G1 H1 I1 J1 K1)
        (funcS__syn B A O P Q R S T U V W X Y Z A1 C D E F G H I J K L)
  ...
  (forall ( (A Int) (B (Array Int Int)) (C Int) (D Int) (E Int) (F Int) (G (Array Int Int)) (H Int) (I Int) (J (Array Int Int)) (K Int) (L Int) (M Bool) (N Int) (O Int) (P Int) (Q Bool) (R Int) (S Int) (T Int) (U Bool) (V Int) (W Int) (X Int) (Y Bool) (Z Int) (A1 Int) (v_27 Int) (v_28 Int) (v_29 Int) (v_30 Int) ) 
    (=>
     ...
     (= v_30 X))
      ...
      (funcS__syn G H M Q U Y L O P S T W X A1 I J K v_27 F v_28 E v_29 D v_30 C)
    )
  )
)
(assert
  (forall ( (A Int) (B (Array Int Int)) (C Int) (D Int) (E Int) (F Int) (G (Array Int Int)) (H Int) (I Int) (J (Array Int Int)) (K Int) (L Bool) (M Int) (N Int) (O Int) (P Bool) (Q Int) (R Int) (S Int) (T Bool) (U Int) (V Int) (W Int) (X Bool) (Y Int) (Z Int) (A1 Int) (v_27 Int) (v_28 Int) (v_29 Int) (v_30 Int) ) 
    (=>
      (and
        (funcE__syn B A L P T X N O R S V W Z A1 I J K M Q U Y)
        (and (= C (ite X Y Z))
     (= E (ite P Q R))
     (= D (ite T U V))
     (= F (ite L M N))
     ...
     (= v_30 A1))
      ...
      (funcS__syn G H L P T X N O R S V W Z A1 I J K F v_27 E v_28 D v_29 C v_30)
    )
  )
)
(assert
  ...
  (forall ( (A (Array Int Int)) (B Int) (C Bool) (D Bool) (E Bool) (F Bool) (G Int) (H Int) (I Int) (J Int) (K Int) (L Int) (M Int) (N Int) (O Int) (P (Array Int Int)) (Q Int) (v_17 Int) (v_18 Int) (v_19 Int) (v_20 Int) ) 
    (=>
     ...
     (= 1 v_20))
      ...
      (funcA__sem A B C D E F G H I J K L M N O P Q v_17 v_18 v_19 v_20)
    )
  )
)
(assert
...
(assert
  (forall ( (A Int) (B Bool) (C Bool) (D Bool) (E Bool) (F (Array Int Int)) (G Int) (H (Array Int Int)) (I Int) (J Bool) (K Bool) (L Bool) (M Bool) (N Int) (O Int) (P Int) (Q Int) (R Int) (S Int) (T Int) (U Int) (V Int) (W (Array Int Int)) (X Int) (Y Int) (Z Int) (A1 Int) (B1 Int) (C1 Int) (D1 Int) (E1 Int) (F1 Int) ) 
    (=>
      (and
        (funcA__sem H A J K L M N O P Q R S T U V F G Y A1 C1 E1)
        (funcA__sem F G J K L M N O P Q R S T U V W X Z B1 D1 F1)
     ...
     (= 1 (select H I)))
      ...
      (funcB__sem H I J K L M N O P Q R S T U V W X E D C B)
    )
  )
)
(assert
  (forall ( (A Int) (B (Array Int Int)) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Int) (L (Array Int Int)) (M Int) (N Bool) (O Bool) (P Bool) (Q Bool) (R Int) (S Int) (T Int) (U Int) (V Int) (W Int) (X Int) (Y Int) (Z Int) (A1 (Array Int Int)) (B1 Int) (C1 Int) (D1 Int) (E1 Int) (F1 Int) (G1 Int) (H1 Int) (I1 Int) (J1 Int) ) 
    (=>
      (and
        (funcS__sem L A N O P Q R S T U V W X Y Z B C D E F G H I J K)
        (funcS__sem B C N O P Q D E F G H I J K Z A1 B1 C1 D1 E1 F1 G1 H1 I1 J1)
  ...
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F (Array Int Int)) (G Int) (H Int) (I (Array Int Int)) (J Int) (K Int) (L Bool) (M Int) (N Int) (O Int) (P Bool) (Q Int) (R Int) (S Int) (T Bool) (U Int) (V Int) (W Int) (X Bool) (Y Int) (Z Int) (v_26 Int) (v_27 Int) (v_28 Int) (v_29 Int) ) 
    (=>
     ...
     (= v_29 W))
      ...
      (funcS__sem F G L P T X K N O R S V W Z H I J v_26 E v_27 D v_28 C v_29 B)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F (Array Int Int)) (G Int) (H Int) (I (Array Int Int)) (J Int) (K Bool) (L Int) (M Int) (N Int) (O Bool) (P Int) (Q Int) (R Int) (S Bool) (T Int) (U Int) (V Int) (W Bool) (X Int) (Y Int) (Z Int) (v_26 Int) (v_27 Int) (v_28 Int) (v_29 Int) ) 
    (=>
      (and
        (funcE__sem F A K O S W M N Q R U V Y Z H I J L P T X)
        (and (= B (ite W X Y))
     (= D (ite O P Q))
     (= A (+ 1 G))
     (= C (ite S T U))
     ...
     (= v_29 Z))
      ...
      (funcS__sem F G K O S W M N Q R U V Y Z H I J E v_26 D v_27 C v_28 B v_29)
    )
  )
)
(assert

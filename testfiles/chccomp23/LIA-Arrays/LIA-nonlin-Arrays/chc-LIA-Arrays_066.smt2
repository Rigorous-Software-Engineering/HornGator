; ./prepared/synth/semgus/./bound.no07_suma2n_06_10_000.smt2
(set-logic HORN)
...
(declare-fun |funcM1__syn| ( (Array Int Int) Int Bool Bool Bool Int Int Int Int Int Int Int Int Int Int (Array Int Int) Int Int Int Int ) Bool)
(declare-fun |funcM__sem| ( (Array Int Int) Int Bool Bool Bool Int Int Int Int Int Int Int Int Int Int (Array Int Int) Int Int Int Int ) Bool)
...
(declare-fun |funcS1__sem| ( (Array Int Int) Int Bool Bool Bool Int Int Int Int Int Int Int Int Int Int (Array Int Int) Int Int Int Int Int Int Int Int Int Int ) Bool)
(declare-fun |funcM1__sem| ( (Array Int Int) Int Bool Bool Bool Int Int Int Int Int Int Int Int Int Int (Array Int Int) Int Int Int Int ) Bool)
...
(declare-fun |funcS2__sem| ( (Array Int Int) Int Bool Bool Bool Int Int Int Int Int Int Int Int Int Int (Array Int Int) Int Int Int Int Int Int Int Int Int Int ) Bool)
...
(declare-fun |funcS2__syn| ( (Array Int Int) Int Bool Bool Bool Int Int Int Int Int Int Int Int Int Int (Array Int Int) Int Int Int Int Int Int Int Int Int Int ) Bool)
(declare-fun |funcS1__syn| ( (Array Int Int) Int Bool Bool Bool Int Int Int Int Int Int Int Int Int Int (Array Int Int) Int Int Int Int Int Int Int Int Int Int ) Bool)
...
(declare-fun |funcM__syn| ( (Array Int Int) Int Bool Bool Bool Int Int Int Int Int Int Int Int Int Int (Array Int Int) Int Int Int Int ) Bool)
...
(assert
  (forall ( (A Int) (B (Array Int Int)) (C (Array Int Int)) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Int) (L Int) (M Int) (N (Array Int Int)) (O Int) (P Bool) (Q Bool) (R Bool) (S Int) (T Int) (U Int) (V Int) (W Int) (X Int) (Y Int) (Z Int) (A1 Int) (B1 Int) (C1 (Array Int Int)) (D1 Int) (E1 Int) (F1 Int) (G1 Int) (H1 Int) (I1 Int) (J1 Int) (K1 Int) (L1 Int) (M1 Int) ) 
    (=>
      (and
        (funcS1__syn C D P Q R E F G H I J K L M B1 C1 D1 E1 F1 G1 H1 I1 J1 K1 L1 M1)
        (funcS1__syn B A P Q R S T U V W X Y Z A1 B1 C D E F G H I J K L M)
        (and (= B (store N O 20)) (= A (+ 1 O)))
      )
      (funcS1__syn N O P Q R S T U V W X Y Z A1 B1 C1 D1 E1 F1 G1 H1 I1 J1 K1 L1 M1)
    )
  )
)
(assert
...
(assert
  (forall ( (A (Array Int Int)) (B Int) (C Bool) (D Bool) (E Bool) (F Int) (G Int) (H Int) (I Int) (J Int) (K Int) (L Int) (M Int) (N Int) (O Int) (P (Array Int Int)) (Q Int) (v_17 Int) (v_18 Int) (v_19 Int) ) 
    (=>
      (and
        (and (= (store A B 6) P) (= B (+ (- 1) Q)) (= 1 v_17) (= 1 v_18) (= 1 v_19))
      )
      (funcA__syn A B C D E F G H I J K L M N O P Q v_17 v_18 v_19)
    )
  )
)
(assert
  (forall ( (A (Array Int Int)) (B Int) (C Bool) (D Bool) (E Bool) (F Int) (G Int) (H Int) (I Int) (J Int) (K Int) (L Int) (M Int) (N Int) (O Int) (P (Array Int Int)) (Q Int) (v_17 Int) (v_18 Int) (v_19 Int) ) 
    (=>
      (and
        (and (= (store A B 5) P) (= B (+ (- 1) Q)) (= 0 v_17) (= 0 v_18) (= 0 v_19))
      )
      (funcA__syn A B C D E F G H I J K L M N O P Q v_17 v_18 v_19)
    )
  )
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D (Array Int Int)) (E Int) (F (Array Int Int)) (G Int) (H Bool) (I Bool) (J Bool) (K Int) (L Int) (M Int) (N Int) (O Int) (P Int) (Q Int) (R (Array Int Int)) (S Int) (T Int) (U Int) (V Int) ) 
    (=>
      (and
        (and (= C (+ (- 1) T))
     (= A (+ (- 1) V))
     ...
     (= B (+ (- 1) U)))
      ...
      (funcM__syn F G H I J K T L M U N O V P Q R S C B A)
    )
  )
)
(assert
    ...
    (=>
      (and
        ...
        (funcStart__sem I1
                ...
                C2
                G2)
        (and (= R (ite (and P1 O1) K1 L1))
     (= Q (ite (and P1 O1) M1 N1))
...
(assert
  (forall ( (A Int) (B (Array Int Int)) (C Bool) (D Bool) (E Bool) (F (Array Int Int)) (G Int) (H (Array Int Int)) (I Int) (J Bool) (K Bool) (L Bool) (M Int) (N Int) (O Int) (P Int) (Q Int) (R Int) (S Int) (T (Array Int Int)) (U Int) (V Int) (W Int) (X Int) (Y Int) (Z Int) (A1 Int) ) 
    (=>
      (and
        (funcM1__syn B A J K L M W N O Y P Q A1 R S F G V X Z)
        (and (= G U)
     (= F T)
     (= B (store H I 1))
     (not (= (<= W V) E))
     ...
     (= A (+ 1 I)))
      ...
      (funcB__syn H I J K L M W N O Y P Q A1 R S T U E D C)
    )
  )
)
(assert
  (forall ( (A Int) (B (Array Int Int)) (C Int) (D Int) (E Int) (F (Array Int Int)) (G Int) (H Int) (I (Array Int Int)) (J Int) (K Int) (L Bool) (M Int) (N Int) (O Int) (P Int) (Q Bool) (R Int) (S Int) (T Int) (U Int) (V Bool) (W Int) (X Int) (Y Int) (v_25 Int) (v_26 Int) (v_27 Int) (v_28 Int) (v_29 Int) (v_30 Int) ) 
    (=>
      (and
        (funcM__syn B A L Q V K N O P S T U X Y H I J M R W)
        (and (= A (+ 1 G))
     (= E (ite L M N))
     (= D (ite Q R S))
     (= B (store F G 3))
...
(assert
  (forall ( (A Int) (B (Array Int Int)) (C (Array Int Int)) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Int) (L Int) (M Int) (N (Array Int Int)) (O Int) (P Bool) (Q Bool) (R Bool) (S Int) (T Int) (U Int) (V Int) (W Int) (X Int) (Y Int) (Z Int) (A1 Int) (B1 Int) (C1 (Array Int Int)) (D1 Int) (E1 Int) (F1 Int) (G1 Int) (H1 Int) (I1 Int) (J1 Int) (K1 Int) (L1 Int) (M1 Int) ) 
    (=>
      (and
        (funcS2__syn C D P Q R E F G H I J K L M B1 C1 D1 E1 F1 G1 H1 I1 J1 K1 L1 M1)
        (funcS1__syn B A P Q R S T U V W X Y Z A1 B1 C D E F G H I J K L M)
  ...
  (forall ( (A Int) (B Int) (C Int) (D (Array Int Int)) (E Int) (F (Array Int Int)) (G Int) (H Bool) (I Bool) (J Bool) (K Int) (L Int) (M Int) (N Int) (O Int) (P Int) (Q Int) (R (Array Int Int)) (S Int) (T Int) (U Int) (V Int) ) 
    (=>
     ...
     (= B (+ (- 1) U)))
      ...
      (funcM1__syn F G H I J T K L U M N V O P Q R S C B A)
    )
  )
)
(assert
...
(assert
  (forall ( (A Int) (B (Array Int Int)) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Int) (L Int) (M (Array Int Int)) (N Int) (O Bool) (P Bool) (Q Bool) (R Int) (S Int) (T Int) (U Int) (V Int) (W Int) (X Int) (Y Int) (Z Int) (A1 Int) (B1 (Array Int Int)) (C1 Int) (D1 Int) (E1 Int) (F1 Int) (G1 Int) (H1 Int) (I1 Int) (J1 Int) (K1 Int) (L1 Int) ) 
    (=>
      (and
        (funcS1__sem M A O P Q R S T U V W X Y Z A1 B C D E F G H I J K L)
        (funcS1__sem B C O P Q D E F G H I J K L A1 B1 C1 D1 E1 F1 G1 H1 I1 J1 K1 L1)
        (and (= A (+ 1 N)) (= 20 (select M N)))
      )
      (funcS1__sem M N O P Q R S T U V W X Y Z A1 B1 C1 D1 E1 F1 G1 H1 I1 J1 K1 L1)
    )
  )
)
(assert
  ...
  (forall ( (A (Array Int Int)) (B Int) (C Bool) (D Bool) (E Bool) (F Int) (G Int) (H Int) (I Int) (J Int) (K Int) (L Int) (M Int) (N Int) (O Int) (P (Array Int Int)) (Q Int) (v_17 Int) (v_18 Int) (v_19 Int) ) 
    (=>
     ...
     (= 1 v_19))
      ...
      (funcA__sem A B C D E F G H I J K L M N O P Q v_17 v_18 v_19)
    )
  )
)
(assert
  ...
  (forall ( (A Int) (B Int) (C Int) (D (Array Int Int)) (E Int) (F (Array Int Int)) (G Int) (H Bool) (I Bool) (J Bool) (K Int) (L Int) (M Int) (N Int) (O Int) (P Int) (Q Int) (R (Array Int Int)) (S Int) (T Int) (U Int) (V Int) ) 
    (=>
     ...
     (= 21 (select F G)))
      ...
      (funcM__sem F G H I J K T L M U N O V P Q R S C B A)
    )
  )
)
(assert
...
(assert
  (forall ( (A Int) (B Bool) (C Bool) (D Bool) (E (Array Int Int)) (F Int) (G (Array Int Int)) (H Int) (I Bool) (J Bool) (K Bool) (L Int) (M Int) (N Int) (O Int) (P Int) (Q Int) (R Int) (S (Array Int Int)) (T Int) (U Int) (V Int) (W Int) (X Int) (Y Int) (Z Int) ) 
    (=>
      (and
        (funcM1__sem G A I J K L V M N X O P Z Q R E F U W Y)
        (and (= F T)
     (= A (+ 1 H))
     (= E S)
     (not (= (<= V U) D))
     ...
     (= 1 (select G H)))
      ...
      (funcB__sem G H I J K L V M N X O P Z Q R S T D C B)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E (Array Int Int)) (F Int) (G Int) (H (Array Int Int)) (I Int) (J Int) (K Bool) (L Int) (M Int) (N Int) (O Int) (P Bool) (Q Int) (R Int) (S Int) (T Int) (U Bool) (V Int) (W Int) (X Int) (v_24 Int) (v_25 Int) (v_26 Int) (v_27 Int) (v_28 Int) (v_29 Int) ) 
    (=>
      (and
        (funcM__sem E A K P U J M N O R S T W X G H I L Q V)
        (and (= B (ite U V W))
     (= D (ite K L M))
     (= A (+ 1 F))
     (= C (ite P Q R))
...
(assert
  (forall ( (A Int) (B (Array Int Int)) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K Int) (L Int) (M (Array Int Int)) (N Int) (O Bool) (P Bool) (Q Bool) (R Int) (S Int) (T Int) (U Int) (V Int) (W Int) (X Int) (Y Int) (Z Int) (A1 Int) (B1 (Array Int Int)) (C1 Int) (D1 Int) (E1 Int) (F1 Int) (G1 Int) (H1 Int) (I1 Int) (J1 Int) (K1 Int) (L1 Int) ) 
    (=>
      (and
        (funcS1__sem M A O P Q R S T U V W X Y Z A1 B C D E F G H I J K L)
        (funcS2__sem B C O P Q D E F G H I J K L A1 B1 C1 D1 E1 F1 G1 H1 I1 J1 K1 L1)
  ...
  (forall ( (A Int) (B Int) (C Int) (D (Array Int Int)) (E Int) (F (Array Int Int)) (G Int) (H Bool) (I Bool) (J Bool) (K Int) (L Int) (M Int) (N Int) (O Int) (P Int) (Q Int) (R (Array Int Int)) (S Int) (T Int) (U Int) (V Int) ) 
    (=>
     ...
     (= 14 (select F G)))
      ...
      (funcM1__sem F G H I J T K L U M N V O P Q R S C B A)
    )
  )
)
(assert

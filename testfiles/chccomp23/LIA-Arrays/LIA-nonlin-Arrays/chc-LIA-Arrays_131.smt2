; ./prepared/synth/semgus/./nthbit.no25_addone_10_4_000.smt2
(set-logic HORN)
...
(assert
  (forall ( (A (Array Int Int)) (B Int) (C (Array Int Int)) (D Int) (E Bool) (F Bool) (G Bool) (H (Array Int Int)) (I Bool) (J Bool) (K Bool) (L Bool) (M Bool) (N Bool) (O Bool) (P (Array Int Int)) (Q Bool) (R Bool) (S Bool) (T Bool) (U Bool) (V Bool) (W Bool) (X (Array Int Int)) (Y Bool) (Z Bool) (A1 Bool) (B1 Bool) (C1 Bool) (D1 Bool) (E1 Bool) (F1 (Array Int Int)) (G1 Int) (v_33 Bool) (v_34 Bool) (v_35 Bool) (v_36 Bool) (v_37 Bool) (v_38 Bool) ) 
    (=>
      (and
        (and (= D (+ (- 1) B))
     (= (store C D 1) A)
    ...
    (=>
      (and
        (funcStart__syn P
                ...
                A
                B2)
        (let ((a!1 (store (store (store (store R1 0 10) 1 11) 2 12) 3 13))
      (a!2 (store (store (store (store R1 0 11) 1 12) 2 13) 3 14))
      (a!3 (= N (store (store (store F1 0 2) 1 3) 2 4)))
      (a!4 (= L (ite U S (store (store T 0 2) 1 3))))
      (a!5 (ite G1 E1 (store (store (store F1 0 3) 1 4) 2 5))))
  (and (= 0 v_54)
       (= v_55 true)
       (= v_56 true)
       (= v_57 true)

; ./prepared/synth/semgus/./nonfusedArray.no08_proda2n_08_000.smt2
(set-logic HORN)


(declare-fun |funcP__sem| ( (Array Int Int) Int Bool Bool Bool Int Int Int Int Int Int Int Int Int (Array Int Int) Int Int Int Int ) Bool)
...
(assert
  (forall ( (A (Array Int Int)) (B Int) (C (Array Int Int)) (D Int) (E (Array Int Int)) (F Int) ) 
    (=>
      (and
        (and (= D (+ (- 1) B)) (= (store C D 22) A) (= A E) (= B F))
      )
      (funcP__syn C D E F)
    )
  )
...
(assert
  (forall ( (A Bool) (B Bool) (C Bool) (D (Array Int Int)) (E Int) (F (Array Int Int)) (G Int) (H Bool) (I Bool) (J Bool) (K Int) (L Int) (M Int) (N (Array Int Int)) (O Int) (P Int) (Q Int) (R Int) (S Int) (T Int) (U Int) ) 
    (=>
      (and
        (and (= E O)
     (= G (+ (- 1) E))
     ...
     (= 1 (select F G)))
      ...
      (funcB__sem F G H I J P Q K R S L T U M N O C B A)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C Int) (D (Array Int Int)) (E Int) (F (Array Int Int)) (G Int) (H Bool) (I Bool) (J Bool) (K Int) (L Int) (M Int) (N Int) (O Int) (P Int) (Q (Array Int Int)) (R Int) (S Int) (T Int) (U Int) ) 
    (=>
     ...
     (= 22 (select F G)))
      ...
      (funcP__sem F G H I J S K L T M N U O P Q R C B A)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E (Array Int Int)) (F Int) (G (Array Int Int)) (H Int) (I Bool) (J Int) (K Int) (L Int) (M Int) (N Bool) (O Int) (P Int) (Q Int) (R Int) (S Bool) (T Int) (U Int) (V Int) (W Int) (v_23 Int) (v_24 Int) (v_25 Int) (v_26 Int) (v_27 Int) (v_28 Int) ) 
    (=>
      (and
        (funcP__sem E A I N S K L M P Q R U V W G H J O T)
        (and (= D (ite I J K))
     (= B (ite S T U))
     (= A (+ 1 F))
     (= C (ite N O P))

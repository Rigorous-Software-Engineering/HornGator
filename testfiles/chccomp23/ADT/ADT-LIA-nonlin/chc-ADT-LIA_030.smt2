; ./prepared/adt-lia/./tip2015_sort_StoogeSort2Count_000.smt2
(set-logic HORN)

(declare-datatypes ((pair_58 0) (list_137 0)) (((pair_59  (projpair_116 list_137) (projpair_117 list_137)))
                                               ((nil_153 ) (cons_137  (head_274 Int) (tail_274 list_137)))))
  ...
  (forall ( (A Int) (B list_137) (C list_137) (D Int) (E list_137) (F Int) (G list_137) (H Int) (v_8 Int) ) 
    (=>
      (and
        ...
        (gt_203 H v_8)
        (take_30 E D G)
        (and (= 0 v_8) (= B (cons_137 F G)) (= C (cons_137 F E)) (= A 1))
      )
      (take_30 C H B)
    )
  )

; ./prepared/adt-lia/./false_regexp_koen_easy_000.smt2
(set-logic HORN)

(declare-datatypes ((Bool_410 0)) (((false_410 ) (true_410 ))))
(declare-datatypes ((R_557 0) (T_20 0)) (((Nil_390 ) (Eps_66 ) (Atom_33  (projAtom_66 T_20)) (x_87578  (proj_192 R_557) (proj_193 R_557)) (x_87579  (proj_194 R_557) (proj_195 R_557)) (Star_33  (projStar_66 R_557)))
                                         ((A_92 ) (B_90 ) (C_51 ))))
  ...
  (forall ( (A list_345) (B R_557) (C list_345) (D R_557) (E Bool_410) (F Bool_410) (G R_557) (H R_557) (I T_20) (J T_20) ) 
    (=>
      (and
        ...
        (rec_19 F D C)
        (rec_19 E B A)
        (and (= C (cons_340 I (cons_340 J nil_389)))
     (= B (x_87579 G H))
     (= D (x_87579 H G))

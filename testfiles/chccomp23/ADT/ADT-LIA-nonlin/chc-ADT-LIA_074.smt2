; ./prepared/adt-lia/./tip2015_sort_MSortBU2Count_000.smt2
(set-logic HORN)

(declare-datatypes ((list_182 0) (list_181 0)) (((nil_207 ) (cons_182  (head_363 list_181) (tail_363 list_182)))
                                                ((nil_206 ) (cons_181  (head_362 Int) (tail_362 list_181)))))
  ...
  (forall ( (A list_181) (B list_182) (C list_181) (D list_182) (E list_181) (F list_182) (G Int) (H list_181) (I Int) ) 
    (=>
      (and
        (risers_3 B A)
        (le_251 I G)
        (and (= C (cons_181 I (cons_181 G H)))
     (= B (cons_182 E F))
     (= D (cons_182 (cons_181 I E) F))
     (= A (cons_181 G H)))
      )
      (risers_3 D C)
    )
...
(assert
  (forall ( (A list_181) (B list_182) (C Int) ) 
    (=>
      (and
        (and (= B (cons_182 (cons_181 C nil_206) nil_207)) (= A (cons_181 C nil_206)))
      )
      (risers_3 B A)
    )
  )

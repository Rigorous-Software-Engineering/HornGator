; ./prepared/adt-lia/./tip2015_list_PairUnpair_000.smt2
(set-logic HORN)

(declare-datatypes ((pair_72 0) (list_180 0)) (((pair_73  (projpair_144 Int) (projpair_145 Int)))
                                               ((nil_205 ) (cons_180  (head_359 pair_72) (tail_359 list_180)))))
...
(assert
  (forall ( (A list_179) (B list_179) (C Int) (D list_179) (E Int) (F list_179) ) 
    (=>
      (and
        (and (= A (cons_179 E F)) (= B (cons_179 C D)) (not (= C E)))
      )
      (diseqlist_179 B A)
    )
  )
...
(assert
  (forall ( (A list_180) (B list_179) (C list_179) (D Int) (E Int) (F list_180) ) 
    (=>
      (and
        (unpair_1 C F)
        (and (= A (cons_180 (pair_73 D E) F)) (= B (cons_179 D (cons_179 E C))))
      )
      (unpair_1 B A)
    )
  )
...
(assert
  (forall ( (A list_179) (B list_180) (C list_180) (D Int) (E list_179) (F Int) ) 
    (=>
      (and
        (pairs_7 C E)
        (and (= B (cons_180 (pair_73 F D) C)) (= A (cons_179 F (cons_179 D E))))
      )
      (pairs_7 B A)
    )
  )

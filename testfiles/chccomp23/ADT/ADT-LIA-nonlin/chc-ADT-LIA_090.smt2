; ./prepared/adt-lia/./false_graph_p11_000.smt2
(set-logic HORN)

(declare-datatypes ((list_373 0) (pair_174 0) (list_374 0)) (((nil_425 ) (cons_367  (head_732 pair_174) (tail_738 list_373)))
...
(declare-datatypes ((Bool_424 0) (list_371 0)) (((false_424 ) (true_424 ))
                                                ((nil_423 ) (cons_365  (head_730 Bool_424) (tail_736 list_371)))))
  ...
  (forall ( (A list_372) (B list_373) (C Int) (D list_373) (E Int) (F list_372) (G Int) ) 
    (=>
      (and
        (add_454 C G E)
        (petersen_24 D G F)
        (and (= B (cons_367 (pair_175 E C) D)) (= A (cons_366 E F)))
      )
      (petersen_24 B G A)
    )
  )
  ...
  (forall ( (A Int) (B list_372) (C list_373) (D Int) (E list_373) (F Int) (G list_372) ) 
    (=>
      (and
        (add_454 D A F)
        (petersen_25 E G)
        (and (= C (cons_367 (pair_175 F D) E)) (= A 1) (= B (cons_366 F G)))
      )
      (petersen_25 C B)
    )
  )
    ...
    (=>
      (and
        ...
        (let ((a!1 (cons_368 (cons_367 (pair_175 F G) (cons_367 (pair_175 C D) nil_425))
                     E)))
  (and (= B a!1) (= A (cons_367 (pair_175 F G) H))))
      )
      (petersen_26 B I A)
    )
  )
...
(assert
  (forall ( (A list_372) (B Maybe_21) (C Int) (D list_372) (v_4 Int) ) 
    (=>
      (and
        (and (= B (Just_21 C)) (= A (cons_366 C D)) (= 0 v_4))
      )
      (index_5 B A v_4)
    )
  )
...
(assert
  (forall ( (A list_372) (B list_371) (C list_371) (D Int) (E list_372) ) 
    (=>
      (and
        (formula_9 C E)
        (and (= A (cons_366 D E)) (not (<= 3 D)) (= B (cons_365 true_424 C)))
      )
      (formula_9 B A)
    )
  )
...
(assert
  (forall ( (A list_372) (B list_371) (C list_371) (D Int) (E list_372) ) 
    (=>
      (and
        (formula_9 C E)
        (and (= A (cons_366 D E)) (>= D 3) (= B (cons_365 false_424 C)))
      )
      (formula_9 B A)
    )
  )

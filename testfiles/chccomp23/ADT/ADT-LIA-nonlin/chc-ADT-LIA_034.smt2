; ./prepared/adt-lia/./isaplanner_prop_72_000.smt2
(set-logic HORN)
...
(assert
  (forall ( (A list_53) (B list_53) (C Int) (D list_53) (E Int) (F list_53) ) 
    (=>
      (and
        (and (= A (cons_53 E F)) (= B (cons_53 C D)) (not (= C E)))
      )
      (diseqlist_53 B A)
    )
  )
...
(assert
  (forall ( (A list_53) (B Int) (C list_53) (D list_53) (E Int) (F list_53) (G Int) ) 
    (=>
      (and
        (take_11 D G F)
        (and (= C (cons_53 E D)) (= A (cons_53 E F)) (>= G 0) (= B (+ 1 G)))
      )
      (take_11 C B A)
    )
  )

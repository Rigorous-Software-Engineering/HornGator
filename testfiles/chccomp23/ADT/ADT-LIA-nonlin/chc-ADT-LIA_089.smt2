; ./prepared/adt-lia/./false_graph_p7_000.smt2
(set-logic HORN)

(declare-datatypes ((list_339 0) (pair_144 0)) (((nil_382 ) (cons_335  (head_668 pair_144) (tail_672 list_339)))
                                                ((pair_145  (projpair_288 Int) (projpair_289 Int)))))
(declare-datatypes ((list_337 0) (Bool_406 0)) (((nil_380 ) (cons_333  (head_666 Bool_406) (tail_670 list_337)))
                                                ((false_406 ) (true_406 ))))
  ...
  (forall ( (A list_338) (B list_339) (C Int) (D list_339) (E Int) (F list_338) (G Int) ) 
    (=>
      (and
        (add_434 C G E)
        (petersen_16 D G F)
        (and (= B (cons_335 (pair_145 E C) D)) (= A (cons_334 E F)))
      )
      (petersen_16 B G A)
    )
  )
  ...
  (forall ( (A Int) (B list_338) (C list_339) (D Int) (E list_339) (F Int) (G list_338) ) 
    (=>
      (and
        (add_434 D A F)
        (petersen_17 E G)
        (and (= C (cons_335 (pair_145 F D) E)) (= A 1) (= B (cons_334 F G)))
      )
      (petersen_17 C B)
    )
  )
    ...
    (=>
      (and
        ...
        (let ((a!1 (cons_336 (cons_335 (pair_145 F G) (cons_335 (pair_145 C D) nil_382))
                     E)))
  (and (= B a!1) (= A (cons_335 (pair_145 F G) H))))
      )
      (petersen_18 B I A)
    )
  )
...
(assert
  (forall ( (A list_338) (B Maybe_13) (C Int) (D list_338) (v_4 Int) ) 
    (=>
      (and
        (and (= B (Just_13 C)) (= A (cons_334 C D)) (= 0 v_4))
      )
      (index_3 B A v_4)
    )
  )
...
(assert
  (forall ( (A list_338) (B list_337) (C list_337) (D Int) (E list_338) ) 
    (=>
      (and
        (formula_7 C E)
        (and (= A (cons_334 D E)) (not (<= 3 D)) (= B (cons_333 true_406 C)))
      )
      (formula_7 B A)
    )
  )
...
(assert
  (forall ( (A list_338) (B list_337) (C list_337) (D Int) (E list_338) ) 
    (=>
      (and
        (formula_7 C E)
        (and (= A (cons_334 D E)) (>= D 3) (= B (cons_333 false_406 C)))
      )
      (formula_7 B A)
    )
  )

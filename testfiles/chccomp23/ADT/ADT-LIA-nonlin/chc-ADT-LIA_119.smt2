; ./prepared/adt-lia/./isaplanner_prop_44_000.smt2
(set-logic HORN)

(declare-datatypes ((list_1 0) (pair_0 0)) (((nil_1 ) (cons_1  (head_1 pair_0) (tail_1 list_1)))
                                            ((pair_1  (projpair_0 Int) (projpair_1 Int)))))
...
(assert
  (forall ( (A pair_0) (B pair_0) (C Int) (D Int) (E Int) (F Int) ) 
    (=>
      (and
        (and (= A (pair_1 E F)) (= B (pair_1 C D)) (not (= C E)))
      )
      (diseqpair_0 B A)
    )
  )
...
(assert
  (forall ( (A pair_0) (B pair_0) (C Int) (D Int) (E Int) (F Int) ) 
    (=>
      (and
        (and (= A (pair_1 E F)) (= B (pair_1 C D)) (not (= D F)))
      )
      (diseqpair_0 B A)
    )
  )

; ./prepared/adt-lia/./tip2015_regexp_SeqDistrPlus_000.smt2
(set-logic HORN)

(declare-datatypes ((A_34 0) (list_141 0)) (((X_31227 ) (Y_1242 ))
                                            ((nil_158 ) (cons_141  (head_282 A_34) (tail_282 list_141)))))

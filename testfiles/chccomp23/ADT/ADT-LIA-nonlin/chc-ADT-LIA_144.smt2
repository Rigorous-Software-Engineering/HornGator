; ./prepared/adt-lia/./false_regexp_kfind3_000.smt2
(set-logic HORN)
...
(declare-datatypes ((pair_196 0) (list_382 0)) (((pair_197  (projpair_392 list_382) (projpair_393 list_382)))
                                                ((nil_438 ) (cons_376  (head_751 T_36) (tail_757 list_382)))))
...
(assert
  (forall ( (A list_382) (B R_637) (C T_36) (D list_382) (E R_637) (v_5 Bool_433) (v_6 Bool_433) ) 
    (=>
      (and
        (eps_93 v_5 E)
        (and (= v_5 true_433) (= B (Star_46 E)) (= A (cons_376 C D)) (= v_6 false_433))
      )
      (reck_10 v_6 B A)
    )
  )
...
(assert
  (forall ( (A list_382) (B R_637) (C T_36) (D list_382) (E T_36) (F T_36) (v_6 Bool_433) ) 
    (=>
      (and
        (and (= B (Atom_46 F)) (= A (cons_376 E (cons_376 C D))) (= v_6 false_433))
      )
      (reck_10 v_6 B A)
    )
  )
...
(assert
  (forall ( (A list_382) (B R_637) (C T_36) (v_3 Bool_433) ) 
    (=>
      (and
        (and (= B (Atom_46 C)) (= A (cons_376 C nil_438)) (= v_3 true_433))
      )
      (reck_10 v_3 B A)
    )
  )
...
(assert
  (forall ( (A list_382) (B R_637) (C T_36) (D T_36) (v_4 Bool_433) ) 
    (=>
      (and
        (diseqT_32 D C)
        (and (= B (Atom_46 D)) (= A (cons_376 C nil_438)) (= v_4 false_433))
      )
      (reck_10 v_4 B A)
    )
  )
  ...
  (forall ( (A list_383) (B list_381) (C Bool_433) (D Bool_433) (E Bool_433) (F list_381) (G list_382) (H list_382) (I list_383) (J R_637) (K R_637) ) 
    (=>
      (and
        ...
        (rec_32 E K H)
        (reck_11 F J K I)
        (and (= A (cons_377 (pair_197 G H) I)) (= B (cons_375 C F)))
      )
      (reck_11 B J K A)
    )
  )

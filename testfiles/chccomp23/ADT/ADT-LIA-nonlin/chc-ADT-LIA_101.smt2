; ./prepared/adt-lia/./tip2015_sort_nat_StoogeSort2Count_000.smt2
(set-logic HORN)

(declare-datatypes ((pair_52 0) (list_131 0)) (((pair_53  (projpair_104 list_131) (projpair_105 list_131)))
                                               ((nil_145 ) (cons_131  (head_262 Int) (tail_262 list_131)))))
...
(assert
  (forall ( (A list_131) (B Int) (C list_131) (D list_131) (E Int) (F list_131) (G Int) ) 
    (=>
      (and
        (take_27 D G F)
        (and (= C (cons_131 E D)) (= A (cons_131 E F)) (= B (+ 1 G)))
      )
      (take_27 C B A)
    )
  )
  ...
  (forall ( (A Int) (B Int) (C Int) (D pair_52) (E list_131) (F list_131) (G Int) (H Int) (I Int) (J list_131) (K list_131) (L list_131) ) 
    (=>
      (and
        ...
        (times_13 H C G)
        (idiv_5 I B A)
        (and (= B (+ 1 H)) (= C 2) (= D (pair_53 J K)) (= A 3))
      )
      (stoogesort_21 E L)
    )
  )

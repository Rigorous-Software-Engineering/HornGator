; ./prepared/adt-lia/./tip2015_sort_nat_NMSortTDIsSort_000.smt2
(set-logic HORN)
...
(assert
  (forall ( (A list_171) (B list_171) (C Int) (D list_171) (E Int) (F list_171) ) 
    (=>
      (and
        (and (= A (cons_171 E F)) (= B (cons_171 C D)) (not (= C E)))
      )
      (diseqlist_171 B A)
    )
  )
...
(assert
  (forall ( (A list_171) (B Int) (C list_171) (D list_171) (E Int) (F list_171) (G Int) ) 
    (=>
      (and
        (take_39 D G F)
        (and (= A (cons_171 E F)) (= C (cons_171 E D)) (= B (+ 1 G)))
      )
      (take_39 C B A)
    )
  )

; ./prepared/adt-lia/./tip2015_sort_nat_MSortTDCount_000.smt2
(set-logic HORN)
...
(assert
  (forall ( (A list_216) (B Int) (C list_216) (D list_216) (E Int) (F list_216) (G Int) ) 
    (=>
      (and
        (take_50 D G F)
        (and (= A (cons_216 E F)) (= C (cons_216 E D)) (>= G 0) (= B (+ 1 G)))
      )
      (take_50 C B A)
    )
  )
  ...
  (forall ( (A list_216) (B list_216) (C list_216) (D list_216) (E list_216) (F list_216) (G list_216) (H list_216) (I list_216) (J Int) (K Int) (L Int) (M list_216) (N Int) ) 
    (=>
      (and
        ...
        (lmerge_17 E G I)
        (length_40 J A)
        (and (= A (cons_216 N (cons_216 L M)))
     (= B (cons_216 N (cons_216 L M)))

; ./prepared/adt-lia/./isaplanner_prop_81_000.smt2
(set-logic HORN)
...
(assert
  (forall ( (A list_50) (B list_50) (C Int) (D list_50) (E Int) (F list_50) ) 
    (=>
      (and
        (and (= A (cons_50 E F)) (= B (cons_50 C D)) (not (= C E)))
      )
      (diseqlist_50 B A)
    )
  )
...
(assert
  (forall ( (A list_50) (B Int) (C list_50) (D list_50) (E Int) (F list_50) (G Int) ) 
    (=>
      (and
        (take_10 D G F)
        (and (= C (cons_50 E D)) (= A (cons_50 E F)) (>= G 0) (= B (+ 1 G)))
      )
      (take_10 C B A)
    )
  )

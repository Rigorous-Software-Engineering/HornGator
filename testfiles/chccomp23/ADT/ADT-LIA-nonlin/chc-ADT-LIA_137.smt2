; ./prepared/adt-lia/./isaplanner_prop_45_000.smt2
(set-logic HORN)

(declare-datatypes ((list_46 0) (pair_16 0)) (((nil_46 ) (cons_46  (head_91 pair_16) (tail_91 list_46)))
                                              ((pair_17  (projpair_32 Int) (projpair_33 Int)))))
...
(assert
  (forall ( (A pair_16) (B pair_16) (C Int) (D Int) (E Int) (F Int) ) 
    (=>
      (and
        (and (= A (pair_17 E F)) (= B (pair_17 C D)) (not (= C E)))
      )
      (diseqpair_8 B A)
    )
  )
...
(assert
  (forall ( (A pair_16) (B pair_16) (C Int) (D Int) (E Int) (F Int) ) 
    (=>
      (and
        (and (= A (pair_17 E F)) (= B (pair_17 C D)) (not (= D F)))
      )
      (diseqpair_8 B A)
    )
  )
...
(assert
  (forall ( (A list_45) (B list_45) (C list_46) (D list_46) (E Int) (F list_45) (G Int) (H list_45) ) 
    (=>
      (and
        (zip_8 D H F)
        (and (= B (cons_45 G H)) (= C (cons_46 (pair_17 G E) D)) (= A (cons_45 E F)))
      )
      (zip_8 C B A)
    )
  )
  ...
  (forall ( (A list_45) (B list_45) (C list_46) (D list_46) (E list_46) (F Int) (G Int) (H list_45) (I list_45) ) 
    (=>
      (and
        ...
        (zip_8 E H I)
        (zip_8 D B A)
        (and (= B (cons_45 F H)) (= C (cons_46 (pair_17 F G) E)) (= A (cons_45 G I)))
      )
      false
    )
  )

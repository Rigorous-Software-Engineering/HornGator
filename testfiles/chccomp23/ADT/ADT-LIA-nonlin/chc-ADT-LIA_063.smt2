; ./prepared/adt-lia/./false_regexp_kfind4_000.smt2
(set-logic HORN)

(declare-datatypes ((R_453 0) (T_2 0)) (((Nil_312 ) (Eps_32 ) (Atom_16  (projAtom_32 T_2)) (x_57455  (proj_36 R_453) (proj_37 R_453)) (x_57456  (proj_38 R_453) (proj_39 R_453)) (Star_16  (projStar_32 R_453)))
                                        ((A_56 ) (B_42 ) (C_24 ))))
(declare-datatypes ((pair_100 0) (list_278 0)) (((pair_101  (projpair_200 list_278) (projpair_201 list_278)))
                                                ((nil_310 ) (cons_278  (head_555 T_2) (tail_555 list_278)))))
...
(assert
  (forall ( (A list_278) (B R_453) (C T_2) (D list_278) (E R_453) (v_5 Bool_372) (v_6 Bool_372) ) 
    (=>
      (and
        (eps_33 v_5 E)
        (and (= v_5 true_372) (= B (Star_16 E)) (= A (cons_278 C D)) (= v_6 false_372))
      )
      (reck_2 v_6 B A)
    )
  )
...
(assert
  (forall ( (A list_278) (B R_453) (C T_2) (D list_278) (E T_2) (F T_2) (v_6 Bool_372) ) 
    (=>
      (and
        (and (= B (Atom_16 F)) (= A (cons_278 E (cons_278 C D))) (= v_6 false_372))
      )
      (reck_2 v_6 B A)
    )
  )
...
(assert
  (forall ( (A list_278) (B R_453) (C T_2) (v_3 Bool_372) ) 
    (=>
      (and
        (and (= B (Atom_16 C)) (= A (cons_278 C nil_310)) (= v_3 true_372))
      )
      (reck_2 v_3 B A)
    )
  )
...
(assert
  (forall ( (A list_278) (B R_453) (C T_2) (D T_2) (v_4 Bool_372) ) 
    (=>
      (and
        (diseqT_2 D C)
        (and (= B (Atom_16 D)) (= A (cons_278 C nil_310)) (= v_4 false_372))
      )
      (reck_2 v_4 B A)
    )
  )
  ...
  (forall ( (A list_279) (B list_277) (C Bool_372) (D Bool_372) (E Bool_372) (F list_277) (G list_278) (H list_278) (I list_279) (J R_453) (K R_453) ) 
    (=>
      (and
        ...
        (rec_2 E K H)
        (reck_3 F J K I)
        (and (= A (cons_279 (pair_101 G H) I)) (= B (cons_277 C F)))
      )
      (reck_3 B J K A)
    )
  )

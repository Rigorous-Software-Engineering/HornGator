; ./prepared/adt-lia/./tip2015_sort_nat_NStoogeSort2IsSort_000.smt2
(set-logic HORN)
...
(assert
  (forall ( (A list_214) (B list_214) (C Int) (D list_214) (E Int) (F list_214) ) 
    (=>
      (and
        (and (= B (cons_214 C D)) (= A (cons_214 E F)) (not (= C E)))
      )
      (diseqlist_214 B A)
    )
  )
...
(assert
  (forall ( (A list_214) (B Int) (C list_214) (D list_214) (E Int) (F list_214) (G Int) ) 
    (=>
      (and
        (take_49 D G F)
        (and (= C (cons_214 E D)) (= A (cons_214 E F)) (= B (+ 1 G)))
      )
      (take_49 C B A)
    )
  )

; ./prepared/adt-lia/./tip2015_sort_nat_NMSortTDCount_000.smt2
(set-logic HORN)
...
(assert
  (forall ( (A list_195) (B Int) (C list_195) (D list_195) (E Int) (F list_195) (G Int) ) 
    (=>
      (and
        (take_43 D G F)
        (and (= A (cons_195 E F)) (= C (cons_195 E D)) (>= G 0) (= B (+ 1 G)))
      )
      (take_43 C B A)
    )
  )

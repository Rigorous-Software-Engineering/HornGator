; ./prepared/adt-lia/./false_graph_d7_000.smt2
(set-logic HORN)

(declare-datatypes ((list_355 0) (Bool_419 0)) (((nil_406 ) (cons_350  (head_700 Bool_419) (tail_705 list_355)))
                                                ((false_419 ) (true_419 ))))
(declare-datatypes ((pair_162 0) (list_357 0)) (((pair_163  (projpair_324 Int) (projpair_325 Int)))
                                                ((nil_408 ) (cons_352  (head_702 pair_162) (tail_707 list_357)))))
...
(assert
  (forall ( (A list_356) (B Maybe_18) (C Int) (D list_356) (v_4 Int) ) 
    (=>
      (and
        (and (= B (Just_18 C)) (= A (cons_351 C D)) (= 0 v_4))
      )
      (index_4 B A v_4)
    )
  )
  ...
  (forall ( (A Int) (B list_356) (C Int) (D Maybe_18) (E Int) (F list_356) (G Int) ) 
    (=>
      (and
        (minus_440 C G A)
        (index_4 D F C)
        (and (not (= G 0)) (= B (cons_351 E F)) (= A 1))
      )
      (index_4 D B G)
    )
  )
  ...
  (forall ( (A Int) (B list_356) (C list_355) (D list_355) (E Int) (F list_356) ) 
    (=>
      (and
        (formula_8 D F)
        (lt_439 E A)
        (and (= C (cons_350 true_419 D)) (= B (cons_351 E F)) (= A 3))
      )
      (formula_8 C B)
    )
  )
  ...
  (forall ( (A Int) (B list_356) (C list_355) (D list_355) (E Int) (F list_356) ) 
    (=>
      (and
        (formula_8 D F)
        (ge_419 E A)
        (and (= C (cons_350 false_419 D)) (= B (cons_351 E F)) (= A 3))
      )
      (formula_8 C B)
    )
  )
  ...
  (forall ( (A Int) (B list_356) (C list_357) (D Int) (E Int) (F Int) (G Int) (H list_357) (I Int) (J list_356) (K Int) (v_11 Int) ) 
    (=>
      (and
        ...
        (add_449 E K D)
        (add_449 F K v_11)
        (and (= v_11 K) (= B (cons_351 I J)) (= C (cons_352 (pair_163 E G) H)) (= A 1))
      )
      (dodeca_23 C K B)
    )
  )
  ...
  (forall ( (A list_356) (B list_357) (C Int) (D Int) (E Int) (F list_357) (G Int) (H list_356) (I Int) (v_9 Int) ) 
    (=>
      (and
        ...
        (add_449 C I G)
        (add_449 D I v_9)
        (and (= v_9 I) (= B (cons_352 (pair_163 C E) F)) (= A (cons_351 G H)))
      )
      (dodeca_24 B I A)
    )
  )
  ...
  (forall ( (A list_356) (B list_357) (C Int) (D list_357) (E Int) (F list_356) (G Int) ) 
    (=>
      (and
        (add_449 C G E)
        (dodeca_25 D G F)
        (and (= B (cons_352 (pair_163 E C) D)) (= A (cons_351 E F)))
      )
      (dodeca_25 B G A)
    )
  )
  ...
  (forall ( (A Int) (B list_356) (C list_357) (D Int) (E list_357) (F Int) (G list_356) ) 
    (=>
      (and
        (add_449 D A F)
        (dodeca_26 E G)
        (and (= B (cons_351 F G)) (= C (cons_352 (pair_163 F D) E)) (= A 1))
      )
      (dodeca_26 C B)
    )
  )

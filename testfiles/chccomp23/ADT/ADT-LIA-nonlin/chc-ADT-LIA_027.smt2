; ./prepared/adt-lia/./isaplanner_prop_46_000.smt2
(set-logic HORN)
...
(assert
  (forall ( (A pair_10) (B pair_10) (C Int) (D Int) (E Int) (F Int) ) 
    (=>
      (and
        (and (= A (pair_11 E F)) (= B (pair_11 C D)) (not (= C E)))
      )
      (diseqpair_5 B A)
    )
  )
...
(assert
  (forall ( (A pair_10) (B pair_10) (C Int) (D Int) (E Int) (F Int) ) 
    (=>
      (and
        (and (= A (pair_11 E F)) (= B (pair_11 C D)) (not (= D F)))
      )
      (diseqpair_5 B A)
    )
  )
...
(assert
  (forall ( (A list_16) (B list_19) (C list_18) (D list_18) (E Int) (F list_16) (G Int) (H list_19) ) 
    (=>
      (and
        (zip_5 D H F)
        (and (= C (cons_18 (pair_11 G E) D)) (= B (cons_19 G H)) (= A (cons_16 E F)))
      )
      (zip_5 C B A)
    )
  )

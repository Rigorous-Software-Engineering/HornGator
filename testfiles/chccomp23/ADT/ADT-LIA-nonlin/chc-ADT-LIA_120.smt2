; ./prepared/adt-lia/./isaplanner_prop_80_000.smt2
(set-logic HORN)
...
(assert
  (forall ( (A list_26) (B list_26) (C Int) (D list_26) (E Int) (F list_26) ) 
    (=>
      (and
        (and (= A (cons_26 E F)) (= B (cons_26 C D)) (not (= C E)))
      )
      (diseqlist_26 B A)
    )
  )
...
(assert
  (forall ( (A list_26) (B Int) (C list_26) (D list_26) (E Int) (F list_26) (G Int) ) 
    (=>
      (and
        (take_6 D G F)
        (and (= A (cons_26 E F)) (= C (cons_26 E D)) (>= G 0) (= B (+ 1 G)))
      )
      (take_6 C B A)
    )
  )

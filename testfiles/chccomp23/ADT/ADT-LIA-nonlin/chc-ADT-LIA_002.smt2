; ./prepared/adt-lia/./tip2015_sort_nat_StoogeSortIsSort_000.smt2
(set-logic HORN)

(declare-datatypes ((list_157 0) (pair_68 0)) (((nil_179 ) (cons_157  (head_314 Int) (tail_314 list_157)))
                                               ((pair_69  (projpair_136 list_157) (projpair_137 list_157)))))
...
(assert
  (forall ( (A list_157) (B list_157) (C Int) (D list_157) (E Int) (F list_157) ) 
    (=>
      (and
        (and (= B (cons_157 C D)) (= A (cons_157 E F)) (not (= C E)))
      )
      (diseqlist_157 B A)
    )
  )
...
(assert
  (forall ( (A list_157) (B Int) (C list_157) (D list_157) (E Int) (F list_157) (G Int) ) 
    (=>
      (and
        (take_37 D G F)
        (and (= C (cons_157 E D)) (= A (cons_157 E F)) (= B (+ 1 G)))
      )
      (take_37 C B A)
    )
  )

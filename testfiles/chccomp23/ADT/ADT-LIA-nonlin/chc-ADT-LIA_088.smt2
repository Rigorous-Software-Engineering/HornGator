; ./prepared/adt-lia/./tip2015_sort_nat_HSortSorts_000.smt2
(set-logic HORN)

(declare-datatypes ((list_144 0) (Heap_6 0)) (((nil_162 ) (cons_144  (head_287 Heap_6) (tail_287 list_144)))
                                              ((Node_9  (projNode_54 Heap_6) (projNode_55 Int) (projNode_56 Heap_6)) (Nil_161 ))))
...
(assert
  (forall ( (A list_143) (B list_144) (C list_144) (D Int) (E list_143) ) 
    (=>
      (and
        (toHeap_8 C E)
        (and (= B (cons_144 (Node_9 Nil_161 D Nil_161) C)) (= A (cons_143 D E)))
      )
      (toHeap_8 B A)
    )
  )
  ...
  (forall ( (A Heap_6) (B list_143) (C Heap_6) (D list_143) (E Heap_6) (F Int) (G Heap_6) ) 
    (=>
      (and
        (toList_6 D C)
        (hmerge_6 C E G)
        (and (= A (Node_9 E F G)) (= B (cons_143 F D)))
      )
      (toList_6 B A)
    )
  )

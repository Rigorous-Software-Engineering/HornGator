; ./prepared/adt-lia/./tip2015_sort_NStoogeSortCount_000.smt2
(set-logic HORN)
  ...
  (forall ( (A Int) (B list_85) (C list_85) (D Int) (E list_85) (F Int) (G list_85) (H Int) (v_8 Int) ) 
    (=>
      (and
        ...
        (gt_114 H v_8)
        (take_16 E D G)
        (and (= 0 v_8) (= C (cons_85 F E)) (= B (cons_85 F G)) (= A 1))
      )
      (take_16 C H B)
    )
  )

; ./prepared/adt-lia/./tip2015_tree_Flatten3_000.smt2
(set-logic HORN)
...
(assert
  (forall ( (A list_217) (B list_217) (C Int) (D list_217) (E Int) (F list_217) ) 
    (=>
      (and
        (and (= B (cons_217 C D)) (= A (cons_217 E F)) (not (= C E)))
      )
      (diseqlist_217 B A)
    )
  )
...
(assert
  (forall ( (A Tree_9) (B list_217) (C list_217) (D Int) (E Tree_9) ) 
    (=>
      (and
        (flatten_10 C E)
        (and (= A (Node_15 Nil_246 D E)) (= B (cons_217 D C)))
      )
      (flatten_10 B A)
    )
  )
  ...
  (forall ( (A list_217) (B Tree_9) (C list_217) (D list_217) (E list_217) (F list_217) (G Tree_9) (H Int) (I Tree_9) ) 
    (=>
      (and
        ...
        (flatten_11 E I)
        (x_53655 F A E)
        (and (= B (Node_15 G H I)) (= A (cons_217 H nil_245)))
      )
      (flatten_11 C B)
    )
  )

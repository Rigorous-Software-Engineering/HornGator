; ./prepared/rust-horn/./trees-4-inc-some2-safe_000.smt2
(set-logic HORN)
  ...
  (forall ( (A ~Mut<%Tree>) (B ~Mut<%Tree>) (C Bool) (D ~Mut<Int>) (E ~Mut<%Tree>) (F ~Mut<Int>) (G Bool) (H Int) (I ~Tup<~Mut<Int>-~Mut<%Tree>>) (J ~Tup<~Mut<Int>-~Mut<%Tree>>) (K Int) (L %Tree) (M %Tree) (N %Tree) (O %Tree) ) 
    (=>
      (and
        ...
        (%take_some_rest A J)
        (%sum M K)
        (let ((a!1 (~mut<Int> (+ 1 (~cur<Int> (~at0/<~Mut<Int>-~Mut<%Tree>> J)))
                      (~ret<Int> (~at0/<~Mut<Int>-~Mut<%Tree>> J))))
      (a!2 (~mut<Int> (+ 1 (~cur<Int> (~at0/<~Mut<Int>-~Mut<%Tree>> I)))
                      (~ret<Int> (~at0/<~Mut<Int>-~Mut<%Tree>> I))))
      (a!3 (= A (~mut<%Tree> (~cur<%Tree> (~at1/<~Mut<Int>-~Mut<%Tree>> I)) O)))
      (a!4 (= E (~mut<%Tree> O (~ret<%Tree> (~at1/<~Mut<Int>-~Mut<%Tree>> I)))))
      (a!5 (not (= (= K (+ 2 H)) C))))
  (and (= (~ret<%Tree> (~at1/<~Mut<Int>-~Mut<%Tree>> J))

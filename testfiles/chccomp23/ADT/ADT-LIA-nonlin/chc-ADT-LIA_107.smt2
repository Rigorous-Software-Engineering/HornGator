; ./prepared/adt-lia/./false_productive_use_of_failure_rot_uhhh_000.smt2
(set-logic HORN)
...
(assert
  (forall ( (A list_276) (B list_276) (C Int) (D list_276) (E Int) (F list_276) ) 
    (=>
      (and
        (and (= A (cons_276 E F)) (= B (cons_276 C D)) (not (= C E)))
      )
      (diseqlist_276 B A)
    )
  )
  ...
  (forall ( (A list_276) (B list_276) (C Int) (D list_276) (E list_276) (F Int) (G list_276) (H Int) ) 
    (=>
      (and
        (rotate_7 D H E)
        (x_57402 E G A)
        (and (= A (cons_276 F nil_308)) (= B (cons_276 F G)) (= C (+ 1 H)))
      )
      (rotate_7 D C B)
    )
  )

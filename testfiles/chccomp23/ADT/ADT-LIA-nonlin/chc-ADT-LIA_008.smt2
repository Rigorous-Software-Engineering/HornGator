; ./prepared/adt-lia/./tip2015_sort_nat_NStoogeSort2Count_000.smt2
(set-logic HORN)

(declare-datatypes ((pair_78 0) (list_186 0)) (((pair_79  (projpair_156 list_186) (projpair_157 list_186)))
                                               ((nil_212 ) (cons_186  (head_372 Int) (tail_372 list_186)))))
...
(assert
  (forall ( (A list_186) (B Int) (C list_186) (D list_186) (E Int) (F list_186) (G Int) ) 
    (=>
      (and
        (take_42 D G F)
        (and (= C (cons_186 E D)) (= A (cons_186 E F)) (= B (+ 1 G)))
      )
      (take_42 C B A)
    )
  )

; ./prepared/adt-lia/./tip2015_sort_StoogeSortCount_000.smt2
(set-logic HORN)
  ...
  (forall ( (A Int) (B list_203) (C list_203) (D Int) (E list_203) (F Int) (G list_203) (H Int) (v_8 Int) ) 
    (=>
      (and
        ...
        (gt_288 H v_8)
        (take_45 E D G)
        (and (= 0 v_8) (= C (cons_203 F E)) (= B (cons_203 F G)) (= A 1))
      )
      (take_45 C H B)
    )
  )

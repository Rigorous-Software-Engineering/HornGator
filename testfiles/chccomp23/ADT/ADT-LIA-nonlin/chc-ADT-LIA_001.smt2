; ./prepared/adt-lia/./tip2015_sort_nat_NStoogeSortIsSort_000.smt2
(set-logic HORN)

(declare-datatypes ((pair_64 0) (list_151 0)) (((pair_65  (projpair_128 list_151) (projpair_129 list_151)))
                                               ((nil_170 ) (cons_151  (head_302 Int) (tail_302 list_151)))))
...
(assert
  (forall ( (A list_151) (B list_151) (C Int) (D list_151) (E Int) (F list_151) ) 
    (=>
      (and
        (and (= B (cons_151 C D)) (= A (cons_151 E F)) (not (= C E)))
      )
      (diseqlist_151 B A)
    )
  )
...
(assert
  (forall ( (A list_151) (B Int) (C list_151) (D list_151) (E Int) (F list_151) (G Int) ) 
    (=>
      (and
        (take_35 D G F)
        (and (= C (cons_151 E D)) (= A (cons_151 E F)) (= B (+ 1 G)))
      )
      (take_35 C B A)
    )
  )

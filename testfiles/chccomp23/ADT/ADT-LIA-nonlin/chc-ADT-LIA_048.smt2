; ./prepared/adt-lia/./false_show_bin_lists_assoc_000.smt2
(set-logic HORN)
  ...
  (forall ( (A Int) (B list_274) (C Int) (D list_274) (E Int) (v_5 Int) ) 
    (=>
      (and
        ...
        (half_3 C E)
        (shw_0 D C)
        (and (= 0 v_5) (not (= E 0)) (= B (cons_274 O_9 D)) (= A 2))
      )
      (shw_0 B E)
    )
  )
  ...
  (forall ( (A Int) (B list_274) (C Int) (D Int) (E list_274) (F Int) ) 
    (=>
      (and
        ...
        (half_3 D F)
        (shw_0 E D)
        (and (not (= C 0)) (not (= F 0)) (= B (cons_274 I_6 E)) (= A 2))
      )
      (shw_0 B F)
    )
  )

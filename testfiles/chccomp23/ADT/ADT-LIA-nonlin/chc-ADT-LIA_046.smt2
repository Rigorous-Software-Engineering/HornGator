; ./prepared/adt-lia/./tip2015_tree_Flatten1_000.smt2
(set-logic HORN)
...
(assert
  (forall ( (A list_163) (B list_163) (C Int) (D list_163) (E Int) (F list_163) ) 
    (=>
      (and
        (and (= B (cons_163 C D)) (= A (cons_163 E F)) (not (= C E)))
      )
      (diseqlist_163 B A)
    )
  )
  ...
  (forall ( (A list_164) (B list_164) (C list_163) (D list_163) (E Int) (F Tree_6) (G list_164) ) 
    (=>
      (and
        (flatten_6 D A)
        (and (= A (cons_164 F G))
     (= B (cons_164 (Node_11 Nil_186 E F) G))
     (= C (cons_163 E D)))
      )
      (flatten_6 C B)
    )
  ...
  (forall ( (A list_163) (B Tree_6) (C list_163) (D list_163) (E list_163) (F list_163) (G Tree_6) (H Int) (I Tree_6) ) 
    (=>
      (and
        ...
        (flatten_7 E I)
        (x_42597 F A E)
        (and (= B (Node_11 G H I)) (= A (cons_163 H nil_185)))
      )
      (flatten_7 C B)
    )
  )

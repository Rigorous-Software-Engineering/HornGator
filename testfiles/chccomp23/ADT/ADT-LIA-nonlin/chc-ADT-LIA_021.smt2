; ./prepared/adt-lia/./false_graph_d5_000.smt2
(set-logic HORN)
...
(declare-datatypes ((list_410 0) (Bool_448 0)) (((nil_472 ) (cons_404  (head_808 Bool_448) (tail_814 list_410)))
                                                ((false_448 ) (true_448 ))))
...
(assert
  (forall ( (A list_411) (B Maybe_26) (C Int) (D list_411) (v_4 Int) ) 
    (=>
      (and
        (and (= B (Just_26 C)) (= A (cons_405 C D)) (= 0 v_4))
      )
      (index_6 B A v_4)
    )
  )
  ...
  (forall ( (A Int) (B list_411) (C Int) (D Maybe_26) (E Int) (F list_411) (G Int) ) 
    (=>
      (and
        (minus_469 C G A)
        (index_6 D F C)
        (and (not (= G 0)) (= B (cons_405 E F)) (= A 1))
      )
      (index_6 D B G)
    )
  )
  ...
  (forall ( (A Int) (B list_411) (C list_410) (D list_410) (E Int) (F list_411) ) 
    (=>
      (and
        (formula_10 D F)
        (lt_468 E A)
        (and (= C (cons_404 true_448 D)) (= B (cons_405 E F)) (= A 3))
      )
      (formula_10 C B)
    )
  )
  ...
  (forall ( (A Int) (B list_411) (C list_410) (D list_410) (E Int) (F list_411) ) 
    (=>
      (and
        (formula_10 D F)
        (ge_448 E A)
        (and (= C (cons_404 false_448 D)) (= B (cons_405 E F)) (= A 3))
      )
      (formula_10 C B)
    )
  )
  ...
  (forall ( (A Int) (B list_411) (C list_412) (D Int) (E Int) (F Int) (G Int) (H list_412) (I Int) (J list_411) (K Int) (v_11 Int) ) 
    (=>
      (and
        ...
        (add_483 E K D)
        (add_483 F K v_11)
        (and (= v_11 K) (= B (cons_405 I J)) (= C (cons_406 (pair_209 E G) H)) (= A 1))
      )
      (dodeca_44 C K B)
    )
  )
  ...
  (forall ( (A list_411) (B list_412) (C Int) (D Int) (E Int) (F list_412) (G Int) (H list_411) (I Int) (v_9 Int) ) 
    (=>
      (and
        ...
        (add_483 C I G)
        (add_483 D I v_9)
        (and (= v_9 I) (= B (cons_406 (pair_209 C E) F)) (= A (cons_405 G H)))
      )
      (dodeca_45 B I A)
    )
  )
  ...
  (forall ( (A list_411) (B list_412) (C Int) (D list_412) (E Int) (F list_411) (G Int) ) 
    (=>
      (and
        (add_483 C G E)
        (dodeca_46 D G F)
        (and (= B (cons_406 (pair_209 E C) D)) (= A (cons_405 E F)))
      )
      (dodeca_46 B G A)
    )
  )
  ...
  (forall ( (A Int) (B list_411) (C list_412) (D Int) (E list_412) (F Int) (G list_411) ) 
    (=>
      (and
        (add_483 D A F)
        (dodeca_47 E G)
        (and (= B (cons_405 F G)) (= C (cons_406 (pair_209 F D) E)) (= A 1))
      )
      (dodeca_47 C B)
    )
  )

; ./prepared/adt-lia/./tip2015_sort_nat_NStoogeSort2Sorts_000.smt2
(set-logic HORN)

(declare-datatypes ((list_142 0) (pair_62 0)) (((nil_159 ) (cons_142  (head_284 Int) (tail_284 list_142)))
                                               ((pair_63  (projpair_124 list_142) (projpair_125 list_142)))))
...
(assert
  (forall ( (A list_142) (B Int) (C list_142) (D list_142) (E Int) (F list_142) (G Int) ) 
    (=>
      (and
        (take_31 D G F)
        (and (= C (cons_142 E D)) (= A (cons_142 E F)) (>= G 0) (= B (+ 1 G)))
      )
      (take_31 C B A)
    )
  )

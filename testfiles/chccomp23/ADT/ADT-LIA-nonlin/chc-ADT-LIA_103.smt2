; ./prepared/adt-lia/./tip2015_sort_MSortBU2IsSort_000.smt2
(set-logic HORN)
...
(assert
  (forall ( (A list_174) (B list_174) (C Int) (D list_174) (E Int) (F list_174) ) 
    (=>
      (and
        (and (= A (cons_174 E F)) (= B (cons_174 C D)) (not (= C E)))
      )
      (diseqlist_174 B A)
    )
  )
  ...
  (forall ( (A list_174) (B list_175) (C list_174) (D list_175) (E list_174) (F list_175) (G Int) (H list_174) (I Int) ) 
    (=>
      (and
        (risers_2 B A)
        (le_243 I G)
        (and (= C (cons_174 I (cons_174 G H)))
     (= B (cons_175 E F))
     (= D (cons_175 (cons_174 I E) F))
     (= A (cons_174 G H)))
      )
      (risers_2 D C)
    )
...
(assert
  (forall ( (A list_174) (B list_175) (C Int) ) 
    (=>
      (and
        (and (= B (cons_175 (cons_174 C nil_199) nil_200)) (= A (cons_174 C nil_199)))
      )
      (risers_2 B A)
    )
  )

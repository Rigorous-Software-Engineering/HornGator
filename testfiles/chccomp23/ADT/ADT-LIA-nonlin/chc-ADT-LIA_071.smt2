; ./prepared/adt-lia/./tip2015_sort_nat_BubSortIsSort_000.smt2
(set-logic HORN)

(declare-datatypes ((list_124 0) (Bool_175 0) (pair_46 0)) (((nil_138 ) (cons_124  (head_248 Int) (tail_248 list_124)))
                                                            ((false_175 ) (true_175 ))
...
(assert
  (forall ( (A list_124) (B list_124) (C Int) (D list_124) (E Int) (F list_124) ) 
    (=>
      (and
        (and (= A (cons_124 E F)) (= B (cons_124 C D)) (not (= C E)))
      )
      (diseqlist_124 B A)
    )
  )
...
(assert
  (forall ( (A list_124) (B pair_46) (C Int) ) 
    (=>
      (and
        (and (= B (pair_47 false_175 (cons_124 C nil_138))) (= A (cons_124 C nil_138)))
      )
      (bubble_2 B A)
    )
  )

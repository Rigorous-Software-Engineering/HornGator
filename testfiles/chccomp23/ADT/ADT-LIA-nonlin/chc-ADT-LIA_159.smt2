; ./prepared/adt-lia/./tip2015_sort_nat_StoogeSort2Sorts_000.smt2
(set-logic HORN)

(declare-datatypes ((pair_36 0) (list_109 0)) (((pair_37  (projpair_72 list_109) (projpair_73 list_109)))
                                               ((nil_120 ) (cons_109  (head_218 Int) (tail_218 list_109)))))
...
(assert
  (forall ( (A list_109) (B Int) (C list_109) (D list_109) (E Int) (F list_109) (G Int) ) 
    (=>
      (and
        (take_22 D G F)
        (and (= C (cons_109 E D)) (= A (cons_109 E F)) (= B (+ 1 G)))
      )
      (take_22 C B A)
    )
  )
  ...
  (forall ( (A Int) (B pair_36) (C list_109) (D list_109) (E Int) (F Int) (G Int) (H list_109) (I list_109) (J list_109) ) 
    (=>
      (and
        ...
        (length_9 E J)
        (times_9 F A E)
        (and (= G (div (+ 1 F) 3)) (= B (pair_37 H I)) (= A 2))
      )
      (stoogesort_9 C J)
    )
  )

; ./prepared/adt-lia/./tip2015_sort_nat_HSortIsSort_000.smt2
(set-logic HORN)

(declare-datatypes ((list_169 0)) (((nil_193 ) (cons_169  (head_338 Int) (tail_338 list_169)))))
(declare-datatypes ((list_170 0) (Heap_8 0)) (((nil_195 ) (cons_170  (head_339 Heap_8) (tail_339 list_170)))
                                              ((Node_12  (projNode_72 Heap_8) (projNode_73 Int) (projNode_74 Heap_8)) (Nil_194 ))))
...
(assert
  (forall ( (A list_169) (B list_169) (C Int) (D list_169) (E Int) (F list_169) ) 
    (=>
      (and
        (and (= A (cons_169 E F)) (= B (cons_169 C D)) (not (= C E)))
      )
      (diseqlist_169 B A)
    )
  )
...
(assert
  (forall ( (A list_169) (B list_170) (C list_170) (D Int) (E list_169) ) 
    (=>
      (and
        (toHeap_11 C E)
        (and (= B (cons_170 (Node_12 Nil_194 D Nil_194) C)) (= A (cons_169 D E)))
      )
      (toHeap_11 B A)
    )
  )
  ...
  (forall ( (A Heap_8) (B list_169) (C Heap_8) (D list_169) (E Heap_8) (F Int) (G Heap_8) ) 
    (=>
      (and
        (toList_8 D C)
        (hmerge_8 C E G)
        (and (= A (Node_12 E F G)) (= B (cons_169 F D)))
      )
      (toList_8 B A)
    )
  )

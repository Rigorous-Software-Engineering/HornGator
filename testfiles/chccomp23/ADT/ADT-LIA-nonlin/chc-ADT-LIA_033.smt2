; ./prepared/adt-lia/./tip2015_propositional_AndImplication_000.smt2
(set-logic HORN)

(declare-datatypes ((list_211 0) (Bool_301 0)) (((nil_239 ) (cons_211  (head_422 Bool_301) (tail_422 list_211)))
                                                ((false_301 ) (true_301 ))))
(declare-datatypes ((list_212 0) (pair_90 0)) (((nil_240 ) (cons_212  (head_423 pair_90) (tail_423 list_212)))
...
(assert
  (forall ( (A list_212) (B list_212) (C list_212) (D Int) (E Bool_301) (F list_212) (G Int) ) 
    (=>
      (and
        (models_24 C G F)
        (and (= A (cons_212 (pair_91 D E) F))
     (= B (cons_212 (pair_91 D E) C))
     (not (= G D)))
      )
      (models_24 B G A)
    )
...
(assert
  (forall ( (A list_212) (B list_211) (C list_211) (D list_212) (E Int) ) 
    (=>
      (and
        (models_25 C E D)
        (and (= A (cons_212 (pair_91 E false_301) D)) (= B (cons_211 true_301 C)))
      )
      (models_25 B E A)
    )
  )
...
(assert
  (forall ( (A list_212) (B list_211) (C list_211) (D list_212) (E Int) ) 
    (=>
      (and
        (models_26 C E D)
        (and (= A (cons_212 (pair_91 E true_301) D)) (= B (cons_211 true_301 C)))
      )
      (models_26 B E A)
    )
  )
...
(assert
  ...
  (and (= v_6 false_301) (= A (Var_4 E)) a!1))
      )
      (models_27 B A F)
    )
  )
...
(assert
  ...
  (and (= v_6 false_301) (= A (Not_305 (Var_4 E))) a!1))
      )
      (models_27 B A F)
    )
  )
...
(assert
  (forall ( (A Form_4) (B list_213) (C list_212) (D list_213) (E Form_4) (v_5 list_212) (v_6 Bool_301) ) 
    (=>
      (and
        (models_27 B A v_5)
        (and (= v_5 nil_240) (= A (Not_305 E)) (= B (cons_213 C D)) (= v_6 false_301))
      )
      (valid_2 v_6 E)
    )
  )

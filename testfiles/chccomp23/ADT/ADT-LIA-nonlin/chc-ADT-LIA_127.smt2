; ./prepared/adt-lia/./isaplanner_prop_83_000.smt2
(set-logic HORN)
...
(assert
  (forall ( (A pair_2) (B pair_2) (C Int) (D Int) (E Int) (F Int) ) 
    (=>
      (and
        (and (= A (pair_3 E F)) (= B (pair_3 C D)) (not (= C E)))
      )
      (diseqpair_1 B A)
    )
  )
...
(assert
  (forall ( (A pair_2) (B pair_2) (C Int) (D Int) (E Int) (F Int) ) 
    (=>
      (and
        (and (= A (pair_3 E F)) (= B (pair_3 C D)) (not (= D F)))
      )
      (diseqpair_1 B A)
    )
  )
...
(assert
  (forall ( (A list_3) (B list_3) (C list_4) (D list_4) (E Int) (F list_3) (G Int) (H list_3) ) 
    (=>
      (and
        (zip_1 D H F)
        (and (= B (cons_3 G H)) (= C (cons_4 (pair_3 G E) D)) (= A (cons_3 E F)))
      )
      (zip_1 C B A)
    )
  )
...
(assert
  (forall ( (A list_3) (B Int) (C list_3) (D list_3) (E Int) (F list_3) (G Int) ) 
    (=>
      (and
        (take_0 D G F)
        (and (= A (cons_3 E F)) (= C (cons_3 E D)) (= B (+ 1 G)))
      )
      (take_0 C B A)
    )
  )
...
(assert
  (forall ( (A list_3) (B Int) (C list_3) (D Int) (E list_3) (F Int) ) 
    (=>
      (and
        (drop_0 C F E)
        (and (= B (+ 1 F)) (= A (cons_3 D E)) (not (= (- 1) F)))
      )
      (drop_0 C B A)
    )
  )

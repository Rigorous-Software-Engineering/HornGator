; ./prepared/adt-lia/./false_productive_use_of_failure_rot_bogus_000.smt2
(set-logic HORN)
...
(assert
  (forall ( (A list_323) (B list_323) (C Int) (D list_323) (E Int) (F list_323) ) 
    (=>
      (and
        (and (= A (cons_319 E F)) (= B (cons_319 C D)) (not (= C E)))
      )
      (diseqlist_319 B A)
    )
  )
  ...
  (forall ( (A list_323) (B list_323) (C Int) (D list_323) (E list_323) (F Int) (G list_323) (H Int) ) 
    (=>
      (and
        (rotate_10 D H E)
        (x_75951 E G A)
        (and (= A (cons_319 F nil_364)) (= B (cons_319 F G)) (>= H 0) (= C (+ 1 H)))
      )
      (rotate_10 D C B)
    )
  )

; ./prepared/adt-lia/./false_regexp_kfind1_000.smt2
(set-logic HORN)

(declare-datatypes ((T_3 0)) (((A_63 ) (B_49 ) (C_28 ))))
(declare-datatypes ((list_296 0) (pair_114 0) (list_295 0)) (((nil_327 ) (cons_294  (head_586 pair_114) (tail_588 list_296)))
                                                             ((pair_115  (projpair_228 list_295) (projpair_229 list_295)))
                                                             ((nil_326 ) (cons_293  (head_585 T_3) (tail_587 list_295)))))
...
(assert
  (forall ( (A list_295) (B R_467) (C T_3) (D list_295) (E R_467) (v_5 Bool_379) (v_6 Bool_379) ) 
    (=>
      (and
        (eps_35 v_5 E)
        (and (= v_5 true_379) (= B (Star_17 E)) (= A (cons_293 C D)) (= v_6 false_379))
      )
      (reck_4 v_6 B A)
    )
  )
...
(assert
  (forall ( (A list_295) (B R_467) (C T_3) (D list_295) (E T_3) (F T_3) (v_6 Bool_379) ) 
    (=>
      (and
        (and (= B (Atom_17 F)) (= A (cons_293 E (cons_293 C D))) (= v_6 false_379))
      )
      (reck_4 v_6 B A)
    )
  )
...
(assert
  (forall ( (A list_295) (B R_467) (C T_3) (v_3 Bool_379) ) 
    (=>
      (and
        (and (= B (Atom_17 C)) (= A (cons_293 C nil_326)) (= v_3 true_379))
      )
      (reck_4 v_3 B A)
    )
  )
...
(assert
  (forall ( (A list_295) (B R_467) (C T_3) (D T_3) (v_4 Bool_379) ) 
    (=>
      (and
        (diseqT_3 D C)
        (and (= B (Atom_17 D)) (= A (cons_293 C nil_326)) (= v_4 false_379))
      )
      (reck_4 v_4 B A)
    )
  )
  ...
  (forall ( (A list_296) (B list_294) (C Bool_379) (D Bool_379) (E Bool_379) (F list_294) (G list_295) (H list_295) (I list_296) (J R_467) (K R_467) ) 
    (=>
      (and
        ...
        (rec_3 E K H)
        (reck_5 F J K I)
        (and (= A (cons_294 (pair_115 G H) I)) (= B (cons_292 C F)))
      )
      (reck_5 B J K A)
    )
  )

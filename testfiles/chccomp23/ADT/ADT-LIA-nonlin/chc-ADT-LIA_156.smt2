; ./prepared/adt-lia/./false_regexp_deluxe_iter_000.smt2
(set-logic HORN)

(declare-datatypes ((list_379 0) (T_34 0)) (((nil_433 ) (cons_373  (head_746 T_34) (tail_752 list_379)))
                                            ((A_116 ) (B_124 ) (C_70 ))))
  ...
  (forall ( (A Int) (B R_629) (C Int) (D R_629) (E Int) (F R_629) ) 
    (=>
      (and
        (minus_452 C E A)
        (iter_1 D C F)
        (and (not (= E 0)) (= B (x_115726 F D)) (= A 1))
      )
      (iter_1 B E F)
    )
  )
  ...
  (forall ( (A R_629) (B R_629) (C R_629) (D Int) (E Int) (F R_629) (G list_379) (v_7 Bool_431) (v_8 Bool_431) ) 
    (=>
      (and
        ...
        (iter_1 C E F)
        (eps_89 v_8 F)
        (and (= v_7 true_431) (= v_8 false_431) (= A (x_115725 B C)) (not (= D E)))
      )
      false
    )
  )

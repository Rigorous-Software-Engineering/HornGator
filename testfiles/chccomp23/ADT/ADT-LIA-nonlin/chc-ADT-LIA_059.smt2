; ./prepared/adt-lia/./tip2015_sort_nat_MSortBU2Count_000.smt2
(set-logic HORN)
...
(assert
  (forall ( (A list_192) (B list_193) (C Int) ) 
    (=>
      (and
        (and (= B (cons_193 (cons_192 C nil_218) nil_219)) (= A (cons_192 C nil_218)))
      )
      (risers_4 B A)
    )
  )

; ./prepared/rust-horn/./swap-dec-3-exact-safe_000.smt2
(set-logic HORN)
  ...
  (forall ( (A ~Mut<~Mut<Int>>) (B ~Mut<~Mut<Int>>) (C Int) (D Int) (E ~Mut<~Mut<Int>>) (F ~Mut<~Mut<Int>>) (G Int) (H ~Mut<Int>) (I ~Mut<Int>) ) 
    (=>
      (and
        ...
        (let ((a!1 (~mut<Int> (+ (- 2) (~cur<Int> (~cur<~Mut<Int>> F)))
                      (~ret<Int> (~cur<~Mut<Int>> F))))
      (a!2 (~mut<Int> (+ (- 1) (~cur<Int> (~cur<~Mut<Int>> E)))

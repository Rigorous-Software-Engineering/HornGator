; ./prepared/rust-horn/./swap2-dec-3-exact-safe_000.smt2
(set-logic HORN)
  ...
  (forall ( (A ~Mut<~Mut<~Mut<Int>>>) (B ~Mut<~Mut<~Mut<Int>>>) (C Bool) (D Bool) (E Int) (F Int) (G Int) (H Int) (I ~Mut<Int>) (J ~Mut<~Mut<Int>>) (K ~Mut<~Mut<Int>>) (L Int) (M ~Mut<Int>) (N ~Mut<~Mut<Int>>) (O ~Mut<~Mut<Int>>) ) 
    (=>
      (and
        ...
        (let ((a!1 (= B (~mut<~Mut<~Mut<Int>>> (~mut<~Mut<Int>> (~mut<Int> F H) I) K)))
      (a!2 (= A (~mut<~Mut<~Mut<Int>>> (~mut<~Mut<Int>> (~mut<Int> G L) M) O))))
  (and (= N O)
       (= J K)
  ...
  (forall ( (A ~Mut<~Mut<~Mut<Int>>>) (B ~Mut<~Mut<~Mut<Int>>>) (C Int) (D Int) (E ~Mut<~Mut<~Mut<Int>>>) (F ~Mut<~Mut<~Mut<Int>>>) (G Int) (H ~Mut<~Mut<Int>>) (I ~Mut<~Mut<Int>>) ) 
    (=>
      (and
        ...
        (let ((a!1 (+ (- 2) (~cur<Int> (~cur<~Mut<Int>> (~cur<~Mut<~Mut<Int>>> F)))))
      (a!4 (+ (- 1) (~cur<Int> (~cur<~Mut<Int>> (~cur<~Mut<~Mut<Int>>> E))))))
(let ((a!2 (~mut<Int> a!1

; ./prepared/rust-horn/./swap2-dec-2-base3-unsafe_000.smt2
(set-logic HORN)

(declare-datatypes ((~Mut<~Mut<Int>> 0) (~Mut<Int> 0)) (((~mut<~Mut<Int>>  (~cur<~Mut<Int>> ~Mut<Int>) (~ret<~Mut<Int>> ~Mut<Int>)))
                                                        ((~mut<Int>  (~cur<Int> Int) (~ret<Int> Int)))))
(declare-datatypes ((~Mut<~Mut<~Mut<Int>>> 0)) (((~mut<~Mut<~Mut<Int>>>  (~cur<~Mut<~Mut<Int>>> ~Mut<~Mut<Int>>) (~ret<~Mut<~Mut<Int>>> ~Mut<~Mut<Int>>)))))
  ...
  (forall ( (A ~Mut<~Mut<~Mut<Int>>>) (B ~Mut<~Mut<~Mut<Int>>>) (C ~Mut<~Mut<~Mut<Int>>>) (D Bool) (E Bool) (F Int) (G Int) (H Int) (I Int) (J ~Mut<Int>) (K ~Mut<~Mut<Int>>) (L ~Mut<~Mut<Int>>) (M Int) (N ~Mut<Int>) (O ~Mut<~Mut<Int>>) (P ~Mut<~Mut<Int>>) (Q Int) (R ~Mut<Int>) (S ~Mut<~Mut<Int>>) (T ~Mut<~Mut<Int>>) ) 
    (=>
      (and
        ...
        (let ((a!1 (= A (~mut<~Mut<~Mut<Int>>> (~mut<~Mut<Int>> (~mut<Int> H Q) R) T)))
      (a!2 (= C (~mut<~Mut<~Mut<Int>>> (~mut<~Mut<Int>> (~mut<Int> F I) J) L)))
      (a!3 (= B (~mut<~Mut<~Mut<Int>>> (~mut<~Mut<Int>> (~mut<Int> G M) N) P))))
  (and (= S T)
       (= O P)
       (= K L)
...
(assert
  (forall ( (A ~Mut<~Mut<~Mut<Int>>>) (B ~Mut<~Mut<~Mut<Int>>>) (C ~Mut<~Mut<~Mut<Int>>>) (D ~Mut<~Mut<~Mut<Int>>>) (E ~Mut<~Mut<~Mut<Int>>>) (F ~Mut<~Mut<~Mut<Int>>>) (G ~Mut<~Mut<Int>>) (H ~Mut<~Mut<Int>>) (I ~Mut<~Mut<Int>>) (v_9 Bool) ) 
    (=>
      (and
        (%swap2_dec_three C B A)
        (let ((a!1 (+ (- 3) (~cur<Int> (~cur<~Mut<Int>> (~cur<~Mut<~Mut<Int>>> F)))))
      (a!4 (+ (- 2) (~cur<Int> (~cur<~Mut<Int>> (~cur<~Mut<~Mut<Int>>> E)))))
      (a!7 (+ (- 1) (~cur<Int> (~cur<~Mut<Int>> (~cur<~Mut<~Mut<Int>>> D))))))
(let ((a!2 (~mut<Int> a!1
...
(let ((a!3 (~mut<~Mut<~Mut<Int>>>
             (~mut<~Mut<Int>> a!2 (~ret<~Mut<Int>> (~cur<~Mut<~Mut<Int>>> F)))
             I))
      (a!6 (~mut<~Mut<~Mut<Int>>>
             (~mut<~Mut<Int>> a!5 (~ret<~Mut<Int>> (~cur<~Mut<~Mut<Int>>> E)))
             H))
      (a!9 (~mut<~Mut<~Mut<Int>>>
             (~mut<~Mut<Int>> a!8 (~ret<~Mut<Int>> (~cur<~Mut<~Mut<Int>>> D)))
             G)))
  (and (= (~ret<~Mut<~Mut<Int>>> D) G)
       (= (~ret<~Mut<~Mut<Int>>> F) I)
       (= A a!3)
       (= B a!6)
       (= C a!9)

; ./prepared/adt-lia/./isaplanner_prop_01_000.smt2
(set-logic HORN)
...
(assert
  (forall ( (A list_41) (B list_41) (C Int) (D list_41) (E Int) (F list_41) ) 
    (=>
      (and
        (and (= A (cons_41 E F)) (= B (cons_41 C D)) (not (= C E)))
      )
      (diseqlist_41 B A)
    )
  )
...
(assert
  (forall ( (A list_41) (B Int) (C list_41) (D list_41) (E Int) (F list_41) (G Int) ) 
    (=>
      (and
        (take_8 D G F)
        (and (= B (+ 1 G)) (= A (cons_41 E F)) (= C (cons_41 E D)) (not (= (- 1) G)))
      )
      (take_8 C B A)
    )
  )
...
(assert
  (forall ( (A list_41) (B Int) (C list_41) (D Int) (E list_41) (F Int) ) 
    (=>
      (and
        (drop_8 C F E)
        (and (= B (+ 1 F)) (= A (cons_41 D E)) (not (= (- 1) F)))
      )
      (drop_8 C B A)
    )
  )

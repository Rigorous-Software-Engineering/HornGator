; ./prepared/adt-lia/./tip2015_sort_NStoogeSort2Count_000.smt2
(set-logic HORN)
  ...
  (forall ( (A Int) (B list_132) (C list_132) (D Int) (E list_132) (F Int) (G list_132) (H Int) (v_8 Int) ) 
    (=>
      (and
        ...
        (gt_190 H v_8)
        (take_28 E D G)
        (and (= 0 v_8) (= C (cons_132 F E)) (= B (cons_132 F G)) (= A 1))
      )
      (take_28 C H B)
    )
  )

; ./prepared/adt-lia/./tip2015_sort_HSortCount_000.smt2
(set-logic HORN)
...
(assert
  (forall ( (A list_94) (B list_95) (C list_95) (D Int) (E list_94) ) 
    (=>
      (and
        (toHeap_2 C E)
        (and (= B (cons_95 (Node_3 Nil_102 D Nil_102) C)) (= A (cons_94 D E)))
      )
      (toHeap_2 B A)
    )
  )
  ...
  (forall ( (A Heap_2) (B list_94) (C Heap_2) (D list_94) (E Heap_2) (F Int) (G Heap_2) ) 
    (=>
      (and
        (toList_2 D C)
        (hmerge_2 C E G)
        (and (= A (Node_3 E F G)) (= B (cons_94 F D)))
      )
      (toList_2 B A)
    )
  )

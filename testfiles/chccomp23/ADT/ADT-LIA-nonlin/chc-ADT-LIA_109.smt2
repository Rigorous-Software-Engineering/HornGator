; ./prepared/adt-lia/./tip2015_sort_BubSortCount_000.smt2
(set-logic HORN)
  ...
  (forall ( (A list_130) (B pair_50) (C list_130) (D pair_50) (E Bool_184) (F list_130) (G Int) (H list_130) (I Int) ) 
    (=>
      (and
        (bubble_3 B A)
        (le_184 I G)
        (and (= C (cons_130 I (cons_130 G H)))
     (= B (pair_51 E F))
     (= D (pair_51 E (cons_130 I F)))
     (= A (cons_130 G H)))
      )
      (bubble_3 D C)
    )
  ...
  (forall ( (A list_130) (B pair_50) (C list_130) (D pair_50) (E Bool_184) (F list_130) (G Int) (H list_130) (I Int) ) 
    (=>
      (and
        ...
        (and (= C (cons_130 I (cons_130 G H)))
     (= B (pair_51 E F))
     (= D (pair_51 true_184 (cons_130 G F)))
     (= A (cons_130 I H)))
      )
      (bubble_3 D C)
    )
...
(assert
  (forall ( (A list_130) (B pair_50) (C Int) ) 
    (=>
      (and
        (and (= B (pair_51 false_184 (cons_130 C nil_144))) (= A (cons_130 C nil_144)))
      )
      (bubble_3 B A)
    )
  )

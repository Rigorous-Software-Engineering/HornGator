; ./prepared/adt-lia/./tip2015_sort_nat_StoogeSortCount_000.smt2
(set-logic HORN)
...
(assert
  (forall ( (A list_80) (B Int) (C list_80) (D list_80) (E Int) (F list_80) (G Int) ) 
    (=>
      (and
        (take_14 D G F)
        (and (= C (cons_80 E D)) (= A (cons_80 E F)) (= B (+ 1 G)))
      )
      (take_14 C B A)
    )
  )

; ./prepared/adt-lia/./false_productive_use_of_failure_rot_comm_000.smt2
(set-logic HORN)
...
(assert
  (forall ( (A list_395) (B list_395) (C Int) (D list_395) (E Int) (F list_395) ) 
    (=>
      (and
        (and (= A (cons_389 E F)) (= B (cons_389 C D)) (not (= C E)))
      )
      (diseqlist_389 B A)
    )
  )
  ...
  (forall ( (A list_395) (B list_395) (C Int) (D list_395) (E list_395) (F Int) (G list_395) (H Int) ) 
    (=>
      (and
        (rotate_12 D H E)
        (x_125924 E G A)
        (and (= A (cons_389 F nil_454)) (= B (cons_389 F G)) (= C (+ 1 H)))
      )
      (rotate_12 D C B)
    )
  )

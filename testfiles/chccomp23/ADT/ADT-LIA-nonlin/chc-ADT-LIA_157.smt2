; ./prepared/adt-lia/./false_graph_bt5_000.smt2
(set-logic HORN)
...
(declare-datatypes ((list_331 0) (B_78 0) (list_332 0)) (((nil_372 ) (cons_327  (head_651 B_78) (tail_655 list_331)))
                                                         ((I_9 ) (O_10 ))
                                                         ((nil_373 ) (cons_328  (head_652 list_331) (tail_656 list_332)))))
(declare-datatypes ((list_328 0)) (((nil_369 ) (cons_324  (head_648 Bool_402) (tail_652 list_328)))))
(declare-datatypes ((pair_142 0) (list_333 0)) (((pair_143  (projpair_282 list_331) (projpair_283 list_331)))
                                                ((nil_374 ) (cons_329  (head_653 pair_142) (tail_657 list_333)))))
  ...
  (forall ( (A Int) (B list_329) (C list_330) (D Int) (E Int) (F Int) (G Int) (H list_330) (I Int) (J list_329) (K Int) (v_11 Int) ) 
    (=>
      (and
        ...
        (add_430 E K D)
        (add_430 F K v_11)
        (and (= v_11 K) (= B (cons_325 I J)) (= C (cons_326 (pair_141 E G) H)) (= A 1))
      )
      (dodeca_16 C K B)
    )
  )
  ...
  (forall ( (A list_329) (B list_330) (C Int) (D Int) (E Int) (F list_330) (G Int) (H list_329) (I Int) (v_9 Int) ) 
    (=>
      (and
        ...
        (add_430 C I G)
        (add_430 D I v_9)
        (and (= v_9 I) (= B (cons_326 (pair_141 C E) F)) (= A (cons_325 G H)))
      )
      (dodeca_17 B I A)
    )
  )
  ...
  (forall ( (A list_329) (B list_330) (C Int) (D list_330) (E Int) (F list_329) (G Int) ) 
    (=>
      (and
        (add_430 C G E)
        (dodeca_18 D G F)
        (and (= B (cons_326 (pair_141 E C) D)) (= A (cons_325 E F)))
      )
      (dodeca_18 B G A)
    )
  )
  ...
  (forall ( (A Int) (B list_329) (C list_330) (D Int) (E list_330) (F Int) (G list_329) ) 
    (=>
      (and
        (add_430 D A F)
        (dodeca_19 E G)
        (and (= B (cons_325 F G)) (= C (cons_326 (pair_141 F D) E)) (= A 1))
      )
      (dodeca_19 C B)
    )
  )
  ...
  (forall ( (A Int) (B Int) (C list_331) (D Int) (E list_331) (F Int) (v_6 Int) ) 
    (=>
      (and
        ...
        (bin_17 E D)
        (div_402 D F A)
        (and (= 0 v_6) (= B 2) (not (= F 0)) (= C (cons_327 O_10 E)) (= A 2))
      )
      (bin_17 C F)
    )
  )
  ...
  (forall ( (A Int) (B Int) (C list_331) (D Int) (E Int) (F list_331) (G Int) ) 
    (=>
      (and
        ...
        (bin_17 F D)
        (div_402 D G A)
        (and (= A 2) (not (= E 0)) (not (= G 0)) (= C (cons_327 I_9 F)) (= B 2))
      )
      (bin_17 C G)
    )
  )
  ...
  (forall ( (A list_330) (B list_333) (C list_331) (D list_331) (E list_333) (F Int) (G Int) (H list_330) ) 
    (=>
      (and
        ...
        (bin_17 C F)
        (bin_17 D G)
        (and (= B (cons_329 (pair_143 C D) E)) (= A (cons_326 (pair_141 F G) H)))
      )
      (bgraph_1 B A)
    )
  )
  ...
  (forall ( (A list_333) (B list_328) (C Bool_402) (D Bool_402) (E Bool_402) (F Bool_402) (G Bool_402) (H Bool_402) (I Bool_402) (J list_328) (K list_331) (L list_331) (M list_333) (N list_331) (O list_331) ) 
    (=>
      (and
        ...
        (and_405 C F G)
        (and_405 D H I)
        (and (= A (cons_329 (pair_143 K L) M)) (= B (cons_324 E J)))
      )
      (bpath_2 B N O A)
    )
  )
  ...
  (forall ( (A list_332) (B list_328) (C Bool_402) (D list_328) (E list_331) (F list_332) (G list_331) ) 
    (=>
      (and
        (belem_2 D G F)
        (beq_1 C G E)
        (and (= A (cons_328 E F)) (= B (cons_324 C D)))
      )
      (belem_2 B G A)
    )
  )

; ./prepared/adt-lia/./tip2015_propositional_AndIdempotent_000.smt2
(set-logic HORN)

(declare-datatypes ((list_128 0) (pair_48 0) (Bool_180 0)) (((nil_142 ) (cons_128  (head_255 pair_48) (tail_255 list_128)))
                                                            ((pair_49  (projpair_96 Int) (projpair_97 Bool_180)))
                                                            ((false_180 ) (true_180 ))))
...
(assert
  (forall ( (A list_128) (B list_128) (C list_128) (D Int) (E Bool_180) (F list_128) (G Int) ) 
    (=>
      (and
        (models_6 C G F)
        (and (= A (cons_128 (pair_49 D E) F))
     (= B (cons_128 (pair_49 D E) C))
     (not (= G D)))
      )
      (models_6 B G A)
    )
...
(assert
  (forall ( (A list_128) (B list_127) (C list_127) (D list_128) (E Int) ) 
    (=>
      (and
        (models_7 C E D)
        (and (= A (cons_128 (pair_49 E false_180) D)) (= B (cons_127 true_180 C)))
      )
      (models_7 B E A)
    )
  )
...
(assert
  (forall ( (A list_128) (B list_127) (C list_127) (D list_128) (E Int) ) 
    (=>
      (and
        (models_8 C E D)
        (and (= A (cons_128 (pair_49 E true_180) D)) (= B (cons_127 true_180 C)))
      )
      (models_8 B E A)
    )
  )
...
(assert
  ...
  (and (= v_6 false_180) (= A (Var_1 E)) a!1))
      )
      (models_9 B A F)
    )
  )
...
(assert
  ...
  (and (= v_6 false_180) (= A (Not_181 (Var_1 E))) a!1))
      )
      (models_9 B A F)
    )
  )
...
(assert
  (forall ( (A Form_1) (B list_129) (C list_128) (D list_129) (E Form_1) (v_5 list_128) (v_6 Bool_180) ) 
    (=>
      (and
        (models_9 B A v_5)
        (and (= v_5 nil_142) (= A (Not_181 E)) (= B (cons_129 C D)) (= v_6 false_180))
      )
      (valid_1 v_6 E)
    )
  )

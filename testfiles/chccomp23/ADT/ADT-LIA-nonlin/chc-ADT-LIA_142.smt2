; ./prepared/adt-lia/./tip2015_rotate_structural_mod_000.smt2
(set-logic HORN)
...
(assert
  (forall ( (A list_150) (B list_150) (C Int) (D list_150) (E Int) (F list_150) ) 
    (=>
      (and
        (and (= A (cons_150 E F)) (= B (cons_150 C D)) (not (= C E)))
      )
      (diseqlist_150 B A)
    )
  )
...
(assert
  (forall ( (A list_150) (B Int) (C list_150) (D list_150) (E Int) (F list_150) (G Int) ) 
    (=>
      (and
        (take_34 D G F)
        (and (= A (cons_150 E F)) (= C (cons_150 E D)) (>= G 0) (= B (+ 1 G)))
      )
      (take_34 C B A)
    )
  )
  ...
  (forall ( (A list_150) (B list_150) (C Int) (D list_150) (E list_150) (F Int) (G list_150) (H Int) ) 
    (=>
      (and
        (rotate_3 D H E)
        (x_34598 E G A)
        (and (= A (cons_150 F nil_169)) (= B (cons_150 F G)) (>= H 0) (= C (+ 1 H)))
      )
      (rotate_3 D C B)
    )
  )

; ./prepared/adt-lia/./tip2015_sort_BubSortSorts_000.smt2
(set-logic HORN)

(declare-datatypes ((pair_22 0) (list_77 0) (Bool_96 0)) (((pair_23  (projpair_44 Bool_96) (projpair_45 list_77)))
                                                          ((nil_81 ) (cons_77  (head_154 Int) (tail_154 list_77)))
                                                          ((false_96 ) (true_96 ))))
  ...
  (forall ( (A list_77) (B pair_22) (C list_77) (D pair_22) (E Bool_96) (F list_77) (G Int) (H list_77) (I Int) ) 
    (=>
      (and
        (bubble_0 B A)
        (le_96 I G)
        (and (= C (cons_77 I (cons_77 G H)))
     (= B (pair_23 E F))
     (= D (pair_23 E (cons_77 I F)))
     (= A (cons_77 G H)))
      )
      (bubble_0 D C)
    )
...
(assert
  (forall ( (A list_77) (B pair_22) (C Int) ) 
    (=>
      (and
        (and (= B (pair_23 false_96 (cons_77 C nil_81))) (= A (cons_77 C nil_81)))
      )
      (bubble_0 B A)
    )
  )

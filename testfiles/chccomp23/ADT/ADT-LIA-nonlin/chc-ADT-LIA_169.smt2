; ./prepared/rust-horn/./swap2-dec-4-exact3-safe_000.smt2
(set-logic HORN)
  ...
  (forall ( (A ~Mut<~Mut<~Mut<Int>>>) (B ~Mut<~Mut<~Mut<Int>>>) (C ~Mut<~Mut<~Mut<Int>>>) (D Bool) (E Bool) (F Int) (G Int) (H Int) (I Int) (J Int) (K ~Mut<Int>) (L ~Mut<~Mut<Int>>) (M ~Mut<~Mut<Int>>) (N Int) (O ~Mut<Int>) (P ~Mut<~Mut<Int>>) (Q ~Mut<~Mut<Int>>) (R Int) (S ~Mut<Int>) (T ~Mut<~Mut<Int>>) (U ~Mut<~Mut<Int>>) ) 
    (=>
      (and
        ...
        (let ((a!1 (= A (~mut<~Mut<~Mut<Int>>> (~mut<~Mut<Int>> (~mut<Int> I R) S) U)))
      (a!2 (= C (~mut<~Mut<~Mut<Int>>> (~mut<~Mut<Int>> (~mut<Int> G J) K) M)))
      (a!3 (= B (~mut<~Mut<~Mut<Int>>> (~mut<~Mut<Int>> (~mut<Int> H N) O) Q))))
  (and (= T U)
       (= P Q)
       (= L M)
  ...
  (forall ( (A ~Mut<~Mut<~Mut<Int>>>) (B ~Mut<~Mut<~Mut<Int>>>) (C ~Mut<~Mut<~Mut<Int>>>) (D Int) (E Int) (F ~Mut<~Mut<~Mut<Int>>>) (G ~Mut<~Mut<~Mut<Int>>>) (H ~Mut<~Mut<~Mut<Int>>>) (I Int) (J ~Mut<~Mut<Int>>) (K ~Mut<~Mut<Int>>) (L ~Mut<~Mut<Int>>) ) 
    (=>
      (and
        ...
        (let ((a!1 (+ (- 3) (~cur<Int> (~cur<~Mut<Int>> (~cur<~Mut<~Mut<Int>>> H)))))
      (a!4 (+ (- 2) (~cur<Int> (~cur<~Mut<Int>> (~cur<~Mut<~Mut<Int>>> G)))))
      (a!7 (+ (- 1) (~cur<Int> (~cur<~Mut<Int>> (~cur<~Mut<~Mut<Int>>> F))))))
(let ((a!2 (~mut<Int> a!1
...
(let ((a!3 (~mut<~Mut<~Mut<Int>>>
             (~mut<~Mut<Int>> a!2 (~ret<~Mut<Int>> (~cur<~Mut<~Mut<Int>>> H)))
             L))
      (a!6 (~mut<~Mut<~Mut<Int>>>
             (~mut<~Mut<Int>> a!5 (~ret<~Mut<Int>> (~cur<~Mut<~Mut<Int>>> G)))
             K))
      (a!9 (~mut<~Mut<~Mut<Int>>>
             (~mut<~Mut<Int>> a!8 (~ret<~Mut<Int>> (~cur<~Mut<~Mut<Int>>> F)))
             J)))
  (and (= (~ret<~Mut<~Mut<Int>>> G) K)
       (= (~ret<~Mut<~Mut<Int>>> F) J)
       (= D (+ (- 1) E))
       (not (= I 0))
       (= A a!3)

; ./prepared/adt-lia/./false_productive_use_of_failure_rot_uhhhw1_000.smt2
(set-logic HORN)
...
(assert
  (forall ( (A list_286) (B list_286) (C Int) (D list_286) (E Int) (F list_286) ) 
    (=>
      (and
        (and (= A (cons_285 E F)) (= B (cons_285 C D)) (not (= C E)))
      )
      (diseqlist_285 B A)
    )
  )
  ...
  (forall ( (A list_286) (B list_286) (C Int) (D list_286) (E list_286) (F Int) (G list_286) (H Int) ) 
    (=>
      (and
        (rotate_8 D H E)
        (x_58233 E G A)
        (and (= A (cons_285 F nil_318)) (= B (cons_285 F G)) (= C (+ 1 H)))
      )
      (rotate_8 D C B)
    )
  )

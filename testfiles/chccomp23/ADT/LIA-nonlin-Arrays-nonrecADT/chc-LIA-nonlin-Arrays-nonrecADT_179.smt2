; ./prepared/tricera-adt-arr/./adt-arr/tree_cnstr.i_000.smt2
(set-logic HORN)

(declare-datatypes ((HeapObject 0) (TreeNode 0)) (((O_Int  (getInt Int)) (O_UInt  (getUInt Int)) (O_Addr  (getAddr Int)) (O_TreeNode  (getTreeNode TreeNode)) (defObj ))

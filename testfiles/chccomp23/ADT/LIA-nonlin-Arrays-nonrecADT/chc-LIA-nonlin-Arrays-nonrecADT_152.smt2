; ./prepared/tricera-adt-arr/./adt-arr/dll-simple-white-blue-2.i_000.smt2
(set-logic HORN)
...
(declare-fun |inv_main65| ( Heap Int Int ) Bool)
...
(assert
  (forall ( (A Int) (B Int) (C Heap) (D Int) (E Int) (F Int) (G Heap) (H Int) (I Int) (J Heap) ) 
    (=>
      (and
        (inv_main74 J I H)
    ...
    (=>
      (and
        ...
        (let ((a!1 (ite (and (not (<= F 0)) (>= (HeapSize H) F))
                ...
                defObj)))
(let ((a!2 (O_TSLL (TSLL E (prev (getTSLL a!1)) (data (getTSLL a!1))))))
(let ((a!3 (ite (and (not (<= F 0)) (>= (HeapSize H) F))
                (HeapCtor (HeapSize H) (store (HeapContents H) F a!2))
                H)))
  (and (= D 0) (= D E) (= B G) (= C a!3) ((_ is O_TSLL) a!1) (= A F) (= v_8 B)))))
      )
      (inv_main49 C B v_8)
    )
  )
    ...
    (=>
      (and
        ...
        (let ((a!1 (ite (and (not (<= E 0)) (>= (HeapSize H) E))
                ...
                defObj)))
(let ((a!2 (O_TSLL (TSLL (next (getTSLL a!1)) F (data (getTSLL a!1))))))
(let ((a!3 (ite (and (not (<= E 0)) (>= (HeapSize H) E))
                (HeapCtor (HeapSize H) (store (HeapContents H) E a!2))
                H)))
  (and (= C G) (= B F) (= D a!3) ((_ is O_TSLL) a!1) (= A E) (= v_8 C)))))
      )
      (inv_main49 D C v_8)
    )
  )
...
(let ((a!3 (ite (and (not (<= D 0)) (>= (HeapSize F) D))
                (HeapCtor (HeapSize F) (store (HeapContents F) D a!2))
                F)))
  (and (= A D) (= C a!3) ((_ is O_TSLL) a!1) (= B E) (= v_6 A)))))
      )
      (inv_main49 C A v_6)
    )
  )
...
(let ((a!3 (ite (and (not (<= D 0)) (>= (HeapSize F) D))
                (HeapCtor (HeapSize F) (store (HeapContents F) D a!2))
                F)))
  (and (= A D) (= C a!3) ((_ is O_TSLL) a!1) (= B E)))))
      )
      (inv_main7 C B A)
    )
  )
...
(let ((a!3 (ite (and (not (<= F 0)) (>= (HeapSize H) F))
                (HeapCtor (HeapSize H) (store (HeapContents H) F a!2))
                H)))
  (and (not (= D 0)) (= D E) (= B G) (= C a!3) ((_ is O_TSLL) a!1) (= A F)))))
      )
      (inv_main44 C B A D)
    )
  )
    ...
    (=>
      (and
        ...
        (let ((a!1 (ite (and (not (<= B 0)) (>= (HeapSize E) B))
                ...
                defObj)))
  (and ((_ is O_TSLL) a!1) (= A (prev (getTSLL a!1)))))
      )
    ...
    (=>
      (and
        ...
        (let ((a!1 (ite (and (not (<= B 0)) (>= (HeapSize D) B))
                (select (HeapContents D) B)
                defObj)))
(let ((a!2 (O_TSLL (TSLL C (prev (getTSLL a!1)) (data (getTSLL a!1))))))
(let ((a!3 (ite (and (not (<= B 0)) (>= (HeapSize D) B))
                (HeapCtor (HeapSize D) (store (HeapContents D) B a!2))
                D)))
  (and ((_ is O_TSLL) a!1) (= A a!3)))))
...
(assert
  ...
  (and (= E I) (= D H) (not (= B 0)) (= A 0) (= G a!1) (= C (+ 1 (HeapSize J)))))
      )
      (inv_main22 G E C)
    )
  )

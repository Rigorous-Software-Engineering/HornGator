; ./prepared/tricera-adt-arr/./adt-arr/dll_extends_pointer.i_000.smt2
(set-logic HORN)

(declare-datatypes ((TNode 0) (HeapObject 0) (TData 0)) (((TNode  (next Int) (prev Int) (pData Int) (data TData)))
                                                         ((O_Int  (getInt Int)) (O_UInt  (getUInt Int)) (O_Addr  (getAddr Int)) (O_TData  (getTData TData)) (O_TNode  (getTNode TNode)) (defObj ))
                                                         ((TData  (x Int)))))

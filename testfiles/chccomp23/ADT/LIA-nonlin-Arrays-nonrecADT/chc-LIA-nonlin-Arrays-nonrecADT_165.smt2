; ./prepared/tricera-adt-arr/./adt-arr/skiplist_2lvl.i_000.smt2
(set-logic HORN)

(declare-datatypes ((sl 0)) (((sl  (head Int) (tail Int)))))
(declare-datatypes ((HeapObject 0) (sl_item 0)) (((O_Int  (getInt Int)) (O_UInt  (getUInt Int)) (O_Addr  (getAddr Int)) (O_sl_item  (getsl_item sl_item)) (O_sl  (getsl sl)) (defObj ))
                                                 ((sl_item  (n1 Int) (n2 Int)))))

; ./prepared/tricera-adt-arr/./adt-arr/sll-rb-cnstr_1-1.i_000.smt2
(set-logic HORN)
...
(let ((a!3 (ite (and (not (<= E 0)) (>= (HeapSize G) E))
                ...
                G)))
  (and (= A E) (= B F) (= C a!3) ((_ is O_TSLL) a!1) (= D 0)))))
      )
      (inv_main16 C B A)
    )
  )
...
(let ((a!3 (ite (and (not (<= E 0)) (>= (HeapSize G) E))
                (HeapCtor (HeapSize G) (store (HeapContents G) E a!2))
                G)))
  (and (= A E) (= B F) (= C a!3) ((_ is O_TSLL) a!1) (not (= D 0))))))
      )
      (inv_main15 C B A)
    )
  )
...
(assert
  (forall ( (A Int) (B Heap) (C Int) (D Int) (E Int) (F Int) (G Heap) (v_7 Int) ) 
    (=>
      (and
        (inv_main6 G F E)
        (and (= D F) (= A 0) (= C 0) (= B G) (not (= 0 D)) (= v_7 D))
      )
      (inv_main26 B D v_7)
    )
  )

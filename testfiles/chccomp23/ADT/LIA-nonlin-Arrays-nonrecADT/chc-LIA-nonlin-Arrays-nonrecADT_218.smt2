; ./prepared/tricera-adt-arr/./adt-arr/process_queue.i_000.smt2
(set-logic HORN)

(declare-datatypes ((HeapObject 0) (process_node 0)) (((O_Int  (getInt Int)) (O_UInt  (getUInt Int)) (O_Addr  (getAddr Int)) (O_process_node  (getprocess_node process_node)) (defObj ))
                                                      ((process_node  (process_id Int) (time_to_wait Int) (next Int)))))

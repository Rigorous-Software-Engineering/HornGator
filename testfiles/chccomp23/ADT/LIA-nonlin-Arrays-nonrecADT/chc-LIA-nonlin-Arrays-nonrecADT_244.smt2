...
(declare-fun |inv_main95| ( Heap Int Int Int ) Bool)
...
(declare-fun |inv_main98| ( Heap Int Int Int ) Bool)
...
(let ((a!3 (ite (and (not (<= F 0)) (>= (HeapSize I) F))
                ...
                I)))
  (and (not (= E 0)) (= C H) (= B G) (= A F) ((_ is O_TSLL) a!1) (= D a!3)))))
      )
      (inv_main22 D C B A)
    )
  )
    ...
    (=>
      (and
        ...
        (let ((a!1 (ite (and (not (<= A 0)) (>= (HeapSize D) A))
                ...
                defObj)))
  (and (= C A) ((_ is O_TSLL) a!1) (= 1 (colour (getTSLL a!1)))))
      )
      (inv_main71 D C B A)
    )
  )
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Heap) (E Int) (F Int) (G Int) (H Int) (I Heap) (J Int) (K Int) (L Int) (M Heap) ) 
    (=>
      (and
        (inv_main101 M L K J)
        (let ((a!1 (ite (and (not (<= F 0)) (>= (HeapSize I) F))
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Heap) (E Int) (F Int) (G Int) (H Int) (I Heap) (J Int) (K Int) (L Int) (M Heap) (v_13 Int) ) 
    (=>
      (and
        (inv_main98 M L K J)
...
(let ((a!3 (ite (and (not (<= E 0)) (>= (HeapSize H) E))
                ...
                H)))
  (and (= C G) (= B F) (= A E) ((_ is O_TSLL) a!1) (= D a!3)))))
      )
      (inv_main21 D C B A)
    )
  )
...
(let ((a!3 (ite (and (not (<= D 0)) (>= (HeapSize F) D))
                ...
                F)))
  (and (= A D) (= B E) ((_ is O_TSLL) a!1) (= C a!3) (= v_6 A)))))
      )
...
(let ((a!3 (ite (and (not (<= F 0)) (>= (HeapSize G) F))
                ...
                G)))
  (and (= E a!3) (= D F) (= A (+ 1 (HeapSize E))) ((_ is O_TSLL) a!1) (= B a!4)))))
      )
      (inv_main7 B D A)
    )
  )

; ./prepared/tricera-adt-arr/./adt-arr/list_search-1.i_000.smt2
(set-logic HORN)

(declare-datatypes ((HeapObject 0) (list 0)) (((O_Int  (getInt Int)) (O_UInt  (getUInt Int)) (O_Addr  (getAddr Int)) (O_list  (getlist list)) (defObj ))
                                              ((list  (key Int) (next Int)))))

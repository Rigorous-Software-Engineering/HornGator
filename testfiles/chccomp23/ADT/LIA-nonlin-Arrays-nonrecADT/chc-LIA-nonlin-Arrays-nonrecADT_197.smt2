; ./prepared/tricera-adt-arr/./adt-arr/dll-rb-cnstr_1-2.i_000.smt2
(set-logic HORN)
...
(let ((a!3 (ite (and (not (<= E 0)) (>= (HeapSize G) E))
                ...
                G)))
  (and (= B F) (= A E) (= D 0) ((_ is O_TSLL) a!1) (= C a!3)))))
      )
      (inv_main18 C B A)
    )
  )
...
(assert
  (forall ( (A Int) (B Heap) (C Int) (D Int) (E Int) (F Int) (G Heap) (v_7 Int) ) 
    (=>
      (and
        (inv_main7 G F E)
        (and (not (= 0 D)) (= C 0) (= A 0) (= D F) (= B G) (= v_7 D))
      )
      (inv_main29 B D v_7)
    )
  )

; ./prepared/tricera-adt-arr/./adt-arr/list_and_tree_cnstr-2.i_000.smt2
(set-logic HORN)

(declare-datatypes ((TreeNode 0) (HeapObject 0) (node 0)) (((TreeNode  (left Int) (right Int)))
                                                           ((O_Int  (getInt Int)) (O_UInt  (getUInt Int)) (O_Addr  (getAddr Int)) (O_node  (getnode node)) (O_TreeNode  (getTreeNode TreeNode)) (defObj ))
                                                           ((node  (h Int) (n Int)))))

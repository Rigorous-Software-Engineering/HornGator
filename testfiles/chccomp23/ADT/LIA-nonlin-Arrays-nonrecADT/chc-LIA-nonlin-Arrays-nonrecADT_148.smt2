; ./prepared/tricera-adt-arr/./adt-arr/SyntaxSupportPointer01-1.c_000.smt2
(set-logic HORN)
  ...
  (forall ( (A Heap) (B Int) (C Int) (D Heap) ) 
    (=>
      ...
      (a!2 (ite (and (not (<= C 0)) (>= (HeapSize D) C))
                (HeapCtor (HeapSize D) (store (HeapContents D) C (O_Int B)))
                D)))
...
(let ((a!2 (ite (and (not (<= C 0)) (>= (HeapSize D) C)) a!1 D)))
  (and (= C E) (= A a!2) (= D F) ((_ is O_Int) a!3) (= B (getInt a!3)))))
      )
      (inv_main4 A C)
    )
  )
    ...
    (=>
      (and
        ...
        (let ((a!1 (ite (and (not (<= D 0)) (>= (HeapSize E) D))
                ...
                defObj)))
  (and (= C (getInt a!1)) (= B E) ((_ is O_Int) a!1) (<= 0 C) (= A D)))
      )
      (inv_main7 B A)
    )
  )

...
(declare-fun |inv_main77| ( Heap Int Int Int Int ) Bool)
...
(declare-fun |inv_main95| ( Heap Int Int Int Int ) Bool)
...
(let ((a!3 (ite (and (not (<= G 0)) (>= (HeapSize I) G))
                ...
                I)))
  (and (= D 0) (= E 0) (= E F) (= B H) (= A G) ((_ is O_TSLL) a!1) (= C a!3)))))
      )
      (inv_main21 C B A E)
    )
  )

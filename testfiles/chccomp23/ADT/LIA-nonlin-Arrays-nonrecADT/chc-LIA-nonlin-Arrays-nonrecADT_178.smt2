; ./prepared/tricera-adt-arr/./adt-arr/sll2n_update_all.i_000.smt2
(set-logic HORN)
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Heap) (v_5 Int) ) 
    (=>
      (and
        (inv_main30 E D C B A)
        (let ((a!1 (not (<= 1 (+ D (* (- 1) A))))))
  (and a!1 (= 0 v_5)))
      )
      (inv_main42 E D C B v_5)
    )
  )
)
(assert

; ./prepared/tricera-adt-arr/./adt-arr/simple_and_skiplist_2lvl-2.i_000.smt2
(set-logic HORN)
...
(declare-datatypes ((sl_item 0) (HeapObject 0)) (((sl_item  (n1 Int) (n2 Int)))
                                                 ((O_Int  (getInt Int)) (O_UInt  (getUInt Int)) (O_Addr  (getAddr Int)) (O_node  (getnode node)) (O_sl_item  (getsl_item sl_item)) (O_sl  (getsl sl)) (defObj ))))

; ./prepared/tricera-adt-arr/./adt-arr/sll_length_check-1.i_000.smt2
(set-logic HORN)
...
(assert
  (forall ( (A Int) (B Int) (C Heap) (v_3 Int) ) 
    (=>
      (and
        (inv_main3 C B)
        (and (not (<= B 31)) (= A (+ 1 B)) (= 0 v_3))
      )
      (inv_main11 C B A v_3)
    )
  )
)
(assert
  (forall ( (A Int) (B Int) (C Int) (D Heap) (v_4 Int) ) 
    (=>
      (and
        (inv_main3 D C)
        (and (= A (+ 1 C)) (<= C 31) (= B 0) (= 0 v_4))
      )
      (inv_main11 D C A v_4)
    )
  )
)
(assert
